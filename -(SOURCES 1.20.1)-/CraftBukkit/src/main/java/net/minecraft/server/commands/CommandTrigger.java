...
public class CommandTrigger {
    ...
    private static int addValue(CommandListenerWrapper commandlistenerwrapper, ScoreboardScore scoreboardscore, int i) {
        ...
        commandlistenerwrapper.sendSuccess(() -> {
            return IChatBaseComponent.translatable("commands.trigger.add.success", scoreboardscore.getObjective().getFormattedDisplayName(), i);
        }, true);
    ...
    private static int setValue(CommandListenerWrapper commandlistenerwrapper, ScoreboardScore scoreboardscore, int i) {
        ...
        commandlistenerwrapper.sendSuccess(() -> {
            return IChatBaseComponent.translatable("commands.trigger.set.success", scoreboardscore.getObjective().getFormattedDisplayName(), i);
        }, true);
        return i;
    }
    ...
    private static int simpleTrigger(CommandListenerWrapper commandlistenerwrapper, ScoreboardScore scoreboardscore) {
        ...
        commandlistenerwrapper.sendSuccess(() -> {
            return IChatBaseComponent.translatable("commands.trigger.simple.success", scoreboardscore.getObjective().getFormattedDisplayName());
        }, true);
        return scoreboardscore.getScore();
    }
