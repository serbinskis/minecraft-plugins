...
public class WorldDataServer implements IWorldDataServer, SaveData {
    ...
    public WorldDataServer(WorldSettings worldsettings, WorldOptions worldoptions, WorldDataServer.a worlddataserver_a, Lifecycle lifecycle) {
        this((DataFixer) null, SharedConstants.getCurrentVersion().getDataVersion().getVersion(), (NBTTagCompound) null, false, 0, 0, 0, 0.0F, 0L, 0L, 19133, 0, 0, false, 0, false, false, false, WorldBorder.DEFAULT_SETTINGS, 0, 0, (UUID) null, Sets.newLinkedHashSet(), new HashSet(), new CustomFunctionCallbackTimerQueue<>(CustomFunctionCallbackTimers.SERVER_CALLBACKS), (NBTTagCompound) null, EnderDragonBattle.a.DEFAULT, worldsettings.copy(), worldoptions, worlddataserver_a, lifecycle);
    }
    ...
    public static <T> WorldDataServer parse(Dynamic<T> dynamic, DataFixer datafixer, int i, @Nullable NBTTagCompound nbttagcompound, WorldSettings worldsettings, LevelVersion levelversion, WorldDataServer.a worlddataserver_a, WorldOptions worldoptions, Lifecycle lifecycle) {
        ...
        int k1 = levelversion.levelDataVersion();
