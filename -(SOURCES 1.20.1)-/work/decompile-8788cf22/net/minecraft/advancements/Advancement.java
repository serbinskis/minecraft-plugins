...
public class Advancement {
    ...
    public Advancement.SerializedAdvancement deconstruct() {
        return new Advancement.SerializedAdvancement(this.parent == null ? null : this.parent.getId(), this.display, this.rewards, this.criteria, this.requirements, this.sendsTelemetryEvent);
    }
    ...
    public static class SerializedAdvancement {
        ...
        public static Advancement.SerializedAdvancement advancement() {
            return new Advancement.SerializedAdvancement(true);
        }

        public static Advancement.SerializedAdvancement recipeAdvancement() {
            return new Advancement.SerializedAdvancement(false);
        }
        ...
        public Advancement build(MinecraftKey minecraftkey) {
            if (!this.canBuild((minecraftkey1) -> {
                ...
                return new Advancement(minecraftkey, this.parent, this.display, this.rewards, this.criteria, this.requirements, this.sendsTelemetryEvent);
            }
        }
        ...
        public static Advancement.SerializedAdvancement fromJson(JsonObject jsonobject, LootDeserializationContext lootdeserializationcontext) {
            ...
            if (map.isEmpty()) {
                ...
                boolean flag1 = ChatDeserializer.getAsBoolean(jsonobject, "sends_telemetry_event", false);

                return new Advancement.SerializedAdvancement(minecraftkey, advancementdisplay, advancementrewards, map, astring, flag1);
            }
        }
        ...
        public static Advancement.SerializedAdvancement fromNetwork(PacketDataSerializer packetdataserializer) {
            ...
            return new Advancement.SerializedAdvancement(minecraftkey, advancementdisplay, AdvancementRewards.EMPTY, map, astring, flag);
        }
