...
public class CriterionTriggers {
    ...
    public static final ItemUsedOnLocationTrigger PLACED_BLOCK = (ItemUsedOnLocationTrigger) register(new ItemUsedOnLocationTrigger(new MinecraftKey("placed_block")));
    ...
    public static final ItemUsedOnLocationTrigger ITEM_USED_ON_BLOCK = (ItemUsedOnLocationTrigger) register(new ItemUsedOnLocationTrigger(new MinecraftKey("item_used_on_block")));
    ...
    public static final ItemUsedOnLocationTrigger ALLAY_DROP_ITEM_ON_BLOCK = (ItemUsedOnLocationTrigger) register(new ItemUsedOnLocationTrigger(new MinecraftKey("allay_drop_item_on_block")));
