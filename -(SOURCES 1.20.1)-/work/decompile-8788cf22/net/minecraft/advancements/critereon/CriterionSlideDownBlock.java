...
public class CriterionSlideDownBlock extends CriterionTriggerAbstract<CriterionSlideDownBlock.a> {
    ...
    @Override
    public CriterionSlideDownBlock.a createInstance(JsonObject jsonobject, ContextAwarePredicate contextawarepredicate, LootDeserializationContext lootdeserializationcontext) {
        ...
        return new CriterionSlideDownBlock.a(contextawarepredicate, block, criteriontriggerproperties);
    }
    ...
    public static class a extends CriterionInstanceAbstract {
        ...
        public a(ContextAwarePredicate contextawarepredicate, @Nullable Block block, CriterionTriggerProperties criteriontriggerproperties) {
            super(CriterionSlideDownBlock.ID, contextawarepredicate);
            this.block = block;
            this.state = criteriontriggerproperties;
        }

        public static CriterionSlideDownBlock.a slidesDownBlock(Block block) {
            return new CriterionSlideDownBlock.a(ContextAwarePredicate.ANY, block, CriterionTriggerProperties.ANY);
        }
