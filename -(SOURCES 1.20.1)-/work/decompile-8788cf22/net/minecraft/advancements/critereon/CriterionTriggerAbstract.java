...
public abstract class CriterionTriggerAbstract<T extends CriterionInstanceAbstract> implements CriterionTrigger<T> {
    ...
    protected abstract T createInstance(JsonObject jsonobject, ContextAwarePredicate contextawarepredicate, LootDeserializationContext lootdeserializationcontext);

    @Override
    public final T createInstance(JsonObject jsonobject, LootDeserializationContext lootdeserializationcontext) {
        ContextAwarePredicate contextawarepredicate = CriterionConditionEntity.fromJson(jsonobject, "player", lootdeserializationcontext);
