...
public class CriterionTriggerEnchantedItem extends CriterionTriggerAbstract<CriterionTriggerEnchantedItem.a> {
    ...
    @Override
    public CriterionTriggerEnchantedItem.a createInstance(JsonObject jsonobject, ContextAwarePredicate contextawarepredicate, LootDeserializationContext lootdeserializationcontext) {
        ...
        return new CriterionTriggerEnchantedItem.a(contextawarepredicate, criterionconditionitem, criterionconditionvalue_integerrange);
    }
    ...
    public static class a extends CriterionInstanceAbstract {
        ...
        public a(ContextAwarePredicate contextawarepredicate, CriterionConditionItem criterionconditionitem, CriterionConditionValue.IntegerRange criterionconditionvalue_integerrange) {
            super(CriterionTriggerEnchantedItem.ID, contextawarepredicate);
        ...
        public static CriterionTriggerEnchantedItem.a enchantedItem() {
            return new CriterionTriggerEnchantedItem.a(ContextAwarePredicate.ANY, CriterionConditionItem.ANY, CriterionConditionValue.IntegerRange.ANY);
        }
