...
public class CriterionTriggerFishingRodHooked extends CriterionTriggerAbstract<CriterionTriggerFishingRodHooked.a> {
    ...
    @Override
    public CriterionTriggerFishingRodHooked.a createInstance(JsonObject jsonobject, ContextAwarePredicate contextawarepredicate, LootDeserializationContext lootdeserializationcontext) {
        ...
        return new CriterionTriggerFishingRodHooked.a(contextawarepredicate, criterionconditionitem, contextawarepredicate1, criterionconditionitem1);
    }
    ...
    public static class a extends CriterionInstanceAbstract {
        ...
        public a(ContextAwarePredicate contextawarepredicate, CriterionConditionItem criterionconditionitem, ContextAwarePredicate contextawarepredicate1, CriterionConditionItem criterionconditionitem1) {
            super(CriterionTriggerFishingRodHooked.ID, contextawarepredicate);
        ...
        public static CriterionTriggerFishingRodHooked.a fishedItem(CriterionConditionItem criterionconditionitem, CriterionConditionEntity criterionconditionentity, CriterionConditionItem criterionconditionitem1) {
            return new CriterionTriggerFishingRodHooked.a(ContextAwarePredicate.ANY, criterionconditionitem, CriterionConditionEntity.wrap(criterionconditionentity), criterionconditionitem1);
        }
