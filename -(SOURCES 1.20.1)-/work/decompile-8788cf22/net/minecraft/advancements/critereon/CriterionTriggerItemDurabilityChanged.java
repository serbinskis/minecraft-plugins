...
public class CriterionTriggerItemDurabilityChanged extends CriterionTriggerAbstract<CriterionTriggerItemDurabilityChanged.a> {
    ...
    @Override
    public CriterionTriggerItemDurabilityChanged.a createInstance(JsonObject jsonobject, ContextAwarePredicate contextawarepredicate, LootDeserializationContext lootdeserializationcontext) {
        ...
        return new CriterionTriggerItemDurabilityChanged.a(contextawarepredicate, criterionconditionitem, criterionconditionvalue_integerrange, criterionconditionvalue_integerrange1);
    }
    ...
    public static class a extends CriterionInstanceAbstract {
        ...
        public a(ContextAwarePredicate contextawarepredicate, CriterionConditionItem criterionconditionitem, CriterionConditionValue.IntegerRange criterionconditionvalue_integerrange, CriterionConditionValue.IntegerRange criterionconditionvalue_integerrange1) {
            super(CriterionTriggerItemDurabilityChanged.ID, contextawarepredicate);
        ...
        public static CriterionTriggerItemDurabilityChanged.a changedDurability(CriterionConditionItem criterionconditionitem, CriterionConditionValue.IntegerRange criterionconditionvalue_integerrange) {
            return changedDurability(ContextAwarePredicate.ANY, criterionconditionitem, criterionconditionvalue_integerrange);
        }

        public static CriterionTriggerItemDurabilityChanged.a changedDurability(ContextAwarePredicate contextawarepredicate, CriterionConditionItem criterionconditionitem, CriterionConditionValue.IntegerRange criterionconditionvalue_integerrange) {
            return new CriterionTriggerItemDurabilityChanged.a(contextawarepredicate, criterionconditionitem, criterionconditionvalue_integerrange, CriterionConditionValue.IntegerRange.ANY);
        }
