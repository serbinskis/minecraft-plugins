...
public class CriterionTriggerLevitation extends CriterionTriggerAbstract<CriterionTriggerLevitation.a> {
    ...
    @Override
    public CriterionTriggerLevitation.a createInstance(JsonObject jsonobject, ContextAwarePredicate contextawarepredicate, LootDeserializationContext lootdeserializationcontext) {
        ...
        return new CriterionTriggerLevitation.a(contextawarepredicate, criterionconditiondistance, criterionconditionvalue_integerrange);
    }
    ...
    public static class a extends CriterionInstanceAbstract {
        ...
        public a(ContextAwarePredicate contextawarepredicate, CriterionConditionDistance criterionconditiondistance, CriterionConditionValue.IntegerRange criterionconditionvalue_integerrange) {
            super(CriterionTriggerLevitation.ID, contextawarepredicate);
        ...
        public static CriterionTriggerLevitation.a levitated(CriterionConditionDistance criterionconditiondistance) {
            return new CriterionTriggerLevitation.a(ContextAwarePredicate.ANY, criterionconditiondistance, CriterionConditionValue.IntegerRange.ANY);
        }
