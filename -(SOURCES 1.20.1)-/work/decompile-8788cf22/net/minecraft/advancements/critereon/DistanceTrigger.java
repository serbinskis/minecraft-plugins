...
public class DistanceTrigger extends CriterionTriggerAbstract<DistanceTrigger.a> {
    ...
    @Override
    public DistanceTrigger.a createInstance(JsonObject jsonobject, ContextAwarePredicate contextawarepredicate, LootDeserializationContext lootdeserializationcontext) {
        ...
        return new DistanceTrigger.a(this.id, contextawarepredicate, criterionconditionlocation, criterionconditiondistance);
    }
    ...
    public static class a extends CriterionInstanceAbstract {
        ...
        public static DistanceTrigger.a fallFromHeight(CriterionConditionEntity.a criterionconditionentity_a, CriterionConditionDistance criterionconditiondistance, CriterionConditionLocation criterionconditionlocation) {
            return new DistanceTrigger.a(CriterionTriggers.FALL_FROM_HEIGHT.id, CriterionConditionEntity.wrap(criterionconditionentity_a.build()), criterionconditionlocation, criterionconditiondistance);
        }
        ...
        public static DistanceTrigger.a rideEntityInLava(CriterionConditionEntity.a criterionconditionentity_a, CriterionConditionDistance criterionconditiondistance) {
            return new DistanceTrigger.a(CriterionTriggers.RIDE_ENTITY_IN_LAVA_TRIGGER.id, CriterionConditionEntity.wrap(criterionconditionentity_a.build()), CriterionConditionLocation.ANY, criterionconditiondistance);
        }

        public static DistanceTrigger.a travelledThroughNether(CriterionConditionDistance criterionconditiondistance) {
            return new DistanceTrigger.a(CriterionTriggers.NETHER_TRAVEL.id, ContextAwarePredicate.ANY, CriterionConditionLocation.ANY, criterionconditiondistance);
        }
