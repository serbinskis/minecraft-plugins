...
public class UsingItemTrigger extends CriterionTriggerAbstract<UsingItemTrigger.a> {
    ...
    @Override
    public UsingItemTrigger.a createInstance(JsonObject jsonobject, ContextAwarePredicate contextawarepredicate, LootDeserializationContext lootdeserializationcontext) {
        CriterionConditionItem criterionconditionitem = CriterionConditionItem.fromJson(jsonobject.get("item"));

        return new UsingItemTrigger.a(contextawarepredicate, criterionconditionitem);
    }
    ...
    public static class a extends CriterionInstanceAbstract {
        ...
        public static UsingItemTrigger.a lookingAt(CriterionConditionEntity.a criterionconditionentity_a, CriterionConditionItem.a criterionconditionitem_a) {
            return new UsingItemTrigger.a(CriterionConditionEntity.wrap(criterionconditionentity_a.build()), criterionconditionitem_a.build());
        }
