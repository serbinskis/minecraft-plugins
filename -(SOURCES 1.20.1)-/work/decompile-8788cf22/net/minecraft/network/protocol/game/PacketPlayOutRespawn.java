...
public class PacketPlayOutRespawn implements Packet<PacketListenerPlayOut> {
    ...
    public PacketPlayOutRespawn(ResourceKey<DimensionManager> resourcekey, ResourceKey<World> resourcekey1, long i, EnumGamemode enumgamemode, @Nullable EnumGamemode enumgamemode1, boolean flag, boolean flag1, byte b0, Optional<GlobalPos> optional, int j) {
    ...
    public PacketPlayOutRespawn(PacketDataSerializer packetdataserializer) {
        ...
        this.portalCooldown = packetdataserializer.readVarInt();
    }
