...
public class CommandScoreboard {
    ...
    private static int getScore(CommandListenerWrapper commandlistenerwrapper, String s, ScoreboardObjective scoreboardobjective) throws CommandSyntaxException {
        ...
        if (!scoreboardserver.hasPlayerScore(s, scoreboardobjective)) {
            ...
            commandlistenerwrapper.sendSuccess(() -> {
                return IChatBaseComponent.translatable("commands.scoreboard.players.get.success", s, scoreboardscore.getScore(), scoreboardobjective.getFormattedDisplayName());
            }, false);
    ...
    private static int performOperation(CommandListenerWrapper commandlistenerwrapper, Collection<String> collection, ScoreboardObjective scoreboardobjective, ArgumentMathOperation.a argumentmathoperation_a, Collection<String> collection1, ScoreboardObjective scoreboardobjective1) throws CommandSyntaxException {
        ...
        if (collection.size() == 1) {
            commandlistenerwrapper.sendSuccess(() -> {
                return IChatBaseComponent.translatable("commands.scoreboard.players.operation.success.single", scoreboardobjective.getFormattedDisplayName(), collection.iterator().next(), i);
            }, true);
        } else {
            commandlistenerwrapper.sendSuccess(() -> {
    ...
    private static int enableTrigger(CommandListenerWrapper commandlistenerwrapper, Collection<String> collection, ScoreboardObjective scoreboardobjective) throws CommandSyntaxException {
        if (scoreboardobjective.getCriteria() != IScoreboardCriteria.TRIGGER) {
            ...
            if (i == 0) {
                ...
                if (collection.size() == 1) {
                    commandlistenerwrapper.sendSuccess(() -> {
                        return IChatBaseComponent.translatable("commands.scoreboard.players.enable.success.single", scoreboardobjective.getFormattedDisplayName(), collection.iterator().next());
                    }, true);
                } else {
                    commandlistenerwrapper.sendSuccess(() -> {
    ...
    private static int resetScores(CommandListenerWrapper commandlistenerwrapper, Collection<String> collection) {
        ...
        if (collection.size() == 1) {
            commandlistenerwrapper.sendSuccess(() -> {
                return IChatBaseComponent.translatable("commands.scoreboard.players.reset.all.single", collection.iterator().next());
            }, true);
        } else {
            commandlistenerwrapper.sendSuccess(() -> {
    ...
    private static int resetScore(CommandListenerWrapper commandlistenerwrapper, Collection<String> collection, ScoreboardObjective scoreboardobjective) {
        ...
        if (collection.size() == 1) {
            commandlistenerwrapper.sendSuccess(() -> {
                return IChatBaseComponent.translatable("commands.scoreboard.players.reset.specific.single", scoreboardobjective.getFormattedDisplayName(), collection.iterator().next());
            }, true);
        } else {
            commandlistenerwrapper.sendSuccess(() -> {
    ...
    private static int setScore(CommandListenerWrapper commandlistenerwrapper, Collection<String> collection, ScoreboardObjective scoreboardobjective, int i) {
        ...
        if (collection.size() == 1) {
            commandlistenerwrapper.sendSuccess(() -> {
                return IChatBaseComponent.translatable("commands.scoreboard.players.set.success.single", scoreboardobjective.getFormattedDisplayName(), collection.iterator().next(), i);
            }, true);
        } else {
            commandlistenerwrapper.sendSuccess(() -> {
    ...
    private static int addScore(CommandListenerWrapper commandlistenerwrapper, Collection<String> collection, ScoreboardObjective scoreboardobjective, int i) {
        ...
        if (collection.size() == 1) {
            commandlistenerwrapper.sendSuccess(() -> {
                return IChatBaseComponent.translatable("commands.scoreboard.players.add.success.single", i, scoreboardobjective.getFormattedDisplayName(), collection.iterator().next(), j);
            }, true);
        } else {
            commandlistenerwrapper.sendSuccess(() -> {
    ...
    private static int removeScore(CommandListenerWrapper commandlistenerwrapper, Collection<String> collection, ScoreboardObjective scoreboardobjective, int i) {
        ...
        if (collection.size() == 1) {
            commandlistenerwrapper.sendSuccess(() -> {
                return IChatBaseComponent.translatable("commands.scoreboard.players.remove.success.single", i, scoreboardobjective.getFormattedDisplayName(), collection.iterator().next(), j);
            }, true);
        } else {
            commandlistenerwrapper.sendSuccess(() -> {
    ...
    private static int listTrackedPlayers(CommandListenerWrapper commandlistenerwrapper) {
        ...
        if (collection.isEmpty()) {
            ...
            commandlistenerwrapper.sendSuccess(() -> {
                return IChatBaseComponent.translatable("commands.scoreboard.players.list.success", collection.size(), ChatComponentUtils.formatList(collection));
            }, false);
        }
    ...
    private static int listTrackedPlayerScores(CommandListenerWrapper commandlistenerwrapper, String s) {
        ...
        if (map.isEmpty()) {
            commandlistenerwrapper.sendSuccess(() -> {
                return IChatBaseComponent.translatable("commands.scoreboard.players.list.entity.empty", s);
            }, false);
        } else {
            commandlistenerwrapper.sendSuccess(() -> {
                return IChatBaseComponent.translatable("commands.scoreboard.players.list.entity.success", s, map.size());
            }, false);
            ...
            while (iterator.hasNext()) {
                ...
                commandlistenerwrapper.sendSuccess(() -> {
                    return IChatBaseComponent.translatable("commands.scoreboard.players.list.entity.entry", ((ScoreboardObjective) entry.getKey()).getFormattedDisplayName(), ((ScoreboardScore) entry.getValue()).getScore());
                }, false);
            }
        }
    ...
    private static int clearDisplaySlot(CommandListenerWrapper commandlistenerwrapper, int i) throws CommandSyntaxException {
        ...
        if (scoreboardserver.getDisplayObjective(i) == null) {
            ...
            commandlistenerwrapper.sendSuccess(() -> {
                return IChatBaseComponent.translatable("commands.scoreboard.objectives.display.cleared", Scoreboard.getDisplaySlotNames()[i]);
            }, true);
            return 0;
        }
    }
    ...
    private static int setDisplaySlot(CommandListenerWrapper commandlistenerwrapper, int i, ScoreboardObjective scoreboardobjective) throws CommandSyntaxException {
        ...
        if (scoreboardserver.getDisplayObjective(i) == scoreboardobjective) {
            ...
            commandlistenerwrapper.sendSuccess(() -> {
                return IChatBaseComponent.translatable("commands.scoreboard.objectives.display.set", Scoreboard.getDisplaySlotNames()[i], scoreboardobjective.getDisplayName());
            }, true);
            return 0;
        }
    }
