...
public class CombatTracker {
    ...
    private IChatBaseComponent getMessageForAssistedFall(Entity entity, IChatBaseComponent ichatbasecomponent, String s, String s1) {
        ...
        return !itemstack1.isEmpty() && itemstack1.hasCustomHoverName() ? IChatBaseComponent.translatable(s, this.mob.getDisplayName(), ichatbasecomponent, itemstack1.getDisplayName()) : IChatBaseComponent.translatable(s1, this.mob.getDisplayName(), ichatbasecomponent);
    }
