...
public interface DamageTypes {
    ...
    static void bootstrap(BootstapContext<DamageType> bootstapcontext) {
        ...
        bootstapcontext.register(DamageTypes.FELL_OUT_OF_WORLD, new DamageType("outOfWorld", 0.0F));
        ...
        bootstapcontext.register(DamageTypes.OUTSIDE_BORDER, new DamageType("outsideBorder", 0.0F));
        bootstapcontext.register(DamageTypes.GENERIC_KILL, new DamageType("genericKill", 0.0F));
    }
}
