...
public class Navigation extends NavigationAbstract {
    ...
    public PathEntity createPath(BlockPosition blockposition, int i) {
        ...
        if (!this.level.getBlockState(blockposition).isSolid()) {
            ...
            for (blockposition1 = blockposition.above(); blockposition1.getY() < this.level.getMaxBuildHeight() && this.level.getBlockState(blockposition1).isSolid(); blockposition1 = blockposition1.above()) {
                ;
            }
