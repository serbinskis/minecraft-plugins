...
public class SnifferAi {
    ...
    public static RecipeItemStack getTemptations() {
        return RecipeItemStack.of(Items.TORCHFLOWER_SEEDS);
    }
    ...
    private static void initCoreActivity(BehaviorController<Sniffer> behaviorcontroller) {
        ...
        }, new BehavorMove(10000, 15000), new CountDownCooldownTicks(MemoryModuleType.TEMPTATION_COOLDOWN_TICKS)));
    }
    ...
    private static void initIdleActivity(BehaviorController<Sniffer> behaviorcontroller) {
        behaviorcontroller.addActivityWithConditions(Activity.IDLE, ImmutableList.of(Pair.of(0, new BehaviorMakeLoveAnimal(EntityTypes.SNIFFER, 1.0F) {
            @Override
