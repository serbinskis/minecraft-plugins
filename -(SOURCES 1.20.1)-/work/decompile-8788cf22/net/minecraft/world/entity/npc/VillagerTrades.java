...
public class VillagerTrades {
    ...
    public static final Int2ObjectMap<VillagerTrades.IMerchantRecipeOption[]> WANDERING_TRADER_TRADES = toIntMap(ImmutableMap.of(1, new VillagerTrades.IMerchantRecipeOption[]{new VillagerTrades.h(Items.SEA_PICKLE, 2, 1, 5, 1), new VillagerTrades.h(Items.SLIME_BALL, 4, 1, 5, 1), new VillagerTrades.h(Items.GLOWSTONE, 2, 1, 5, 1), new VillagerTrades.h(Items.NAUTILUS_SHELL, 5, 1, 5, 1), new VillagerTrades.h(Items.FERN, 1, 1, 12, 1), new VillagerTrades.h(Items.SUGAR_CANE, 1, 1, 8, 1), new VillagerTrades.h(Items.PUMPKIN, 1, 1, 4, 1), new VillagerTrades.h(Items.KELP, 3, 1, 12, 1), new VillagerTrades.h(Items.CACTUS, 3, 1, 8, 1), new VillagerTrades.h(Items.DANDELION, 1, 1, 12, 1), new VillagerTrades.h(Items.POPPY, 1, 1, 12, 1), new VillagerTrades.h(Items.BLUE_ORCHID, 1, 1, 8, 1), new VillagerTrades.h(Items.ALLIUM, 1, 1, 12, 1), new VillagerTrades.h(Items.AZURE_BLUET, 1, 1, 12, 1), new VillagerTrades.h(Items.RED_TULIP, 1, 1, 12, 1), new VillagerTrades.h(Items.ORANGE_TULIP, 1, 1, 12, 1), new VillagerTrades.h(Items.WHITE_TULIP, 1, 1, 12, 1), new VillagerTrades.h(Items.PINK_TULIP, 1, 1, 12, 1), new VillagerTrades.h(Items.OXEYE_DAISY, 1, 1, 12, 1), new VillagerTrades.h(Items.CORNFLOWER, 1, 1, 12, 1), new VillagerTrades.h(Items.LILY_OF_THE_VALLEY, 1, 1, 7, 1), new VillagerTrades.h(Items.WHEAT_SEEDS, 1, 1, 12, 1), new VillagerTrades.h(Items.BEETROOT_SEEDS, 1, 1, 12, 1), new VillagerTrades.h(Items.PUMPKIN_SEEDS, 1, 1, 12, 1), new VillagerTrades.h(Items.MELON_SEEDS, 1, 1, 12, 1), new VillagerTrades.h(Items.ACACIA_SAPLING, 5, 1, 8, 1), new VillagerTrades.h(Items.BIRCH_SAPLING, 5, 1, 8, 1), new VillagerTrades.h(Items.DARK_OAK_SAPLING, 5, 1, 8, 1), new VillagerTrades.h(Items.JUNGLE_SAPLING, 5, 1, 8, 1), new VillagerTrades.h(Items.OAK_SAPLING, 5, 1, 8, 1), new VillagerTrades.h(Items.SPRUCE_SAPLING, 5, 1, 8, 1), new VillagerTrades.h(Items.CHERRY_SAPLING, 5, 1, 8, 1), new VillagerTrades.h(Items.MANGROVE_PROPAGULE, 5, 1, 8, 1), new VillagerTrades.h(Items.RED_DYE, 1, 3, 12, 1), new VillagerTrades.h(Items.WHITE_DYE, 1, 3, 12, 1), new VillagerTrades.h(Items.BLUE_DYE, 1, 3, 12, 1), new VillagerTrades.h(Items.PINK_DYE, 1, 3, 12, 1), new VillagerTrades.h(Items.BLACK_DYE, 1, 3, 12, 1), new VillagerTrades.h(Items.GREEN_DYE, 1, 3, 12, 1), new VillagerTrades.h(Items.LIGHT_GRAY_DYE, 1, 3, 12, 1), new VillagerTrades.h(Items.MAGENTA_DYE, 1, 3, 12, 1), new VillagerTrades.h(Items.YELLOW_DYE, 1, 3, 12, 1), new VillagerTrades.h(Items.GRAY_DYE, 1, 3, 12, 1), new VillagerTrades.h(Items.PURPLE_DYE, 1, 3, 12, 1), new VillagerTrades.h(Items.LIGHT_BLUE_DYE, 1, 3, 12, 1), new VillagerTrades.h(Items.LIME_DYE, 1, 3, 12, 1), new VillagerTrades.h(Items.ORANGE_DYE, 1, 3, 12, 1), new VillagerTrades.h(Items.BROWN_DYE, 1, 3, 12, 1), new VillagerTrades.h(Items.CYAN_DYE, 1, 3, 12, 1), new VillagerTrades.h(Items.BRAIN_CORAL_BLOCK, 3, 1, 8, 1), new VillagerTrades.h(Items.BUBBLE_CORAL_BLOCK, 3, 1, 8, 1), new VillagerTrades.h(Items.FIRE_CORAL_BLOCK, 3, 1, 8, 1), new VillagerTrades.h(Items.HORN_CORAL_BLOCK, 3, 1, 8, 1), new VillagerTrades.h(Items.TUBE_CORAL_BLOCK, 3, 1, 8, 1), new VillagerTrades.h(Items.VINE, 1, 1, 12, 1), new VillagerTrades.h(Items.BROWN_MUSHROOM, 1, 1, 12, 1), new VillagerTrades.h(Items.RED_MUSHROOM, 1, 1, 12, 1), new VillagerTrades.h(Items.LILY_PAD, 1, 2, 5, 1), new VillagerTrades.h(Items.SMALL_DRIPLEAF, 1, 2, 5, 1), new VillagerTrades.h(Items.SAND, 1, 8, 8, 1), new VillagerTrades.h(Items.RED_SAND, 1, 4, 6, 1), new VillagerTrades.h(Items.POINTED_DRIPSTONE, 1, 2, 5, 1), new VillagerTrades.h(Items.ROOTED_DIRT, 1, 2, 5, 1), new VillagerTrades.h(Items.MOSS_BLOCK, 1, 2, 5, 1)}, 2, new VillagerTrades.IMerchantRecipeOption[]{new VillagerTrades.h(Items.TROPICAL_FISH_BUCKET, 5, 1, 4, 1), new VillagerTrades.h(Items.PUFFERFISH_BUCKET, 5, 1, 4, 1), new VillagerTrades.h(Items.PACKED_ICE, 3, 1, 6, 1), new VillagerTrades.h(Items.BLUE_ICE, 6, 1, 6, 1), new VillagerTrades.h(Items.GUNPOWDER, 1, 1, 8, 1), new VillagerTrades.h(Items.PODZOL, 3, 3, 6, 1)}));
