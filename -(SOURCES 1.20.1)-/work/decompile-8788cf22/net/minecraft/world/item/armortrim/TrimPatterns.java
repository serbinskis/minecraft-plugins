...
public class TrimPatterns {
    ...
    public static void bootstrap(BootstapContext<TrimPattern> bootstapcontext) {
        ...
        register(bootstapcontext, Items.WAYFINDER_ARMOR_TRIM_SMITHING_TEMPLATE, TrimPatterns.WAYFINDER);
        register(bootstapcontext, Items.SHAPER_ARMOR_TRIM_SMITHING_TEMPLATE, TrimPatterns.SHAPER);
        register(bootstapcontext, Items.SILENCE_ARMOR_TRIM_SMITHING_TEMPLATE, TrimPatterns.SILENCE);
        register(bootstapcontext, Items.RAISER_ARMOR_TRIM_SMITHING_TEMPLATE, TrimPatterns.RAISER);
        register(bootstapcontext, Items.HOST_ARMOR_TRIM_SMITHING_TEMPLATE, TrimPatterns.HOST);
    }
