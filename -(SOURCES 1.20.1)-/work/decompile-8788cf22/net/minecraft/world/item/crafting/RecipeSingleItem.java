    ...
    public static class a<T extends RecipeSingleItem> implements RecipeSerializer<T> {
        ...
        public T fromJson(MinecraftKey minecraftkey, JsonObject jsonobject) {
            ...
            if (ChatDeserializer.isArrayNode(jsonobject, "ingredient")) {
                recipeitemstack = RecipeItemStack.fromJson(ChatDeserializer.getAsJsonArray(jsonobject, "ingredient"), false);
            } else {
                recipeitemstack = RecipeItemStack.fromJson(ChatDeserializer.getAsJsonObject(jsonobject, "ingredient"), false);
            }
