...
public class ShapedRecipes implements RecipeCrafting {
    ...
    static Map<String, RecipeItemStack> keyFromJson(JsonObject jsonobject) {
        ...
        while (iterator.hasNext()) {
            ...
            map.put((String) entry.getKey(), RecipeItemStack.fromJson((JsonElement) entry.getValue(), false));
        }
    ...
    public static Item itemFromJson(JsonObject jsonobject) {
        ...
        Item item = (Item) BuiltInRegistries.ITEM.getOptional(MinecraftKey.tryParse(s)).orElseThrow(() -> {
