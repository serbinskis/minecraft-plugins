...
public class SmithingTrimRecipe implements SmithingRecipe {
    ...
    public static class a implements RecipeSerializer<SmithingTrimRecipe> {
        ...
        public SmithingTrimRecipe fromJson(MinecraftKey minecraftkey, JsonObject jsonobject) {
            RecipeItemStack recipeitemstack = RecipeItemStack.fromJson(ChatDeserializer.getNonNull(jsonobject, "template"));
            RecipeItemStack recipeitemstack1 = RecipeItemStack.fromJson(ChatDeserializer.getNonNull(jsonobject, "base"));
            RecipeItemStack recipeitemstack2 = RecipeItemStack.fromJson(ChatDeserializer.getNonNull(jsonobject, "addition"));
