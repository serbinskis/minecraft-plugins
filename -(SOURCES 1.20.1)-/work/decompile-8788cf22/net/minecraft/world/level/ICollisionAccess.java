...
public interface ICollisionAccess extends IBlockAccess {
    ...
    default boolean collidesWithSuffocatingBlock(@Nullable Entity entity, AxisAlignedBB axisalignedbb) {
        VoxelShapeSpliterator voxelshapespliterator = new VoxelShapeSpliterator<>(this, entity, axisalignedbb, true, (blockposition_mutableblockposition, voxelshape) -> {
            return voxelshape;
        });
    ...
    default Optional<BlockPosition> findSupportingBlock(Entity entity, AxisAlignedBB axisalignedbb) {
        ...
        VoxelShapeSpliterator voxelshapespliterator = new VoxelShapeSpliterator<>(this, entity, axisalignedbb, false, (blockposition_mutableblockposition, voxelshape) -> {
