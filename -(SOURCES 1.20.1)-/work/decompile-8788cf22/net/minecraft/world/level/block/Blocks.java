...
public class Blocks {
    ...
    public static final Block OAK_SAPLING = register("oak_sapling", new BlockSapling(new WorldGenTreeProviderOak(), BlockBase.Info.of().mapColor(MaterialMapColor.PLANT).noCollission().randomTicks().instabreak().sound(SoundEffectType.GRASS).pushReaction(EnumPistonReaction.DESTROY)));
    public static final Block SPRUCE_SAPLING = register("spruce_sapling", new BlockSapling(new WorldGenTreeProviderSpruce(), BlockBase.Info.of().mapColor(MaterialMapColor.PLANT).noCollission().randomTicks().instabreak().sound(SoundEffectType.GRASS).pushReaction(EnumPistonReaction.DESTROY)));
    public static final Block BIRCH_SAPLING = register("birch_sapling", new BlockSapling(new WorldGenTreeProviderBirch(), BlockBase.Info.of().mapColor(MaterialMapColor.PLANT).noCollission().randomTicks().instabreak().sound(SoundEffectType.GRASS).pushReaction(EnumPistonReaction.DESTROY)));
    public static final Block JUNGLE_SAPLING = register("jungle_sapling", new BlockSapling(new WorldGenMegaTreeProviderJungle(), BlockBase.Info.of().mapColor(MaterialMapColor.PLANT).noCollission().randomTicks().instabreak().sound(SoundEffectType.GRASS).pushReaction(EnumPistonReaction.DESTROY)));
    public static final Block ACACIA_SAPLING = register("acacia_sapling", new BlockSapling(new WorldGenTreeProviderAcacia(), BlockBase.Info.of().mapColor(MaterialMapColor.PLANT).noCollission().randomTicks().instabreak().sound(SoundEffectType.GRASS).pushReaction(EnumPistonReaction.DESTROY)));
    public static final Block CHERRY_SAPLING = register("cherry_sapling", new BlockSapling(new CherryTreeGrower(), BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_PINK).noCollission().randomTicks().instabreak().sound(SoundEffectType.CHERRY_SAPLING).pushReaction(EnumPistonReaction.DESTROY)));
    public static final Block DARK_OAK_SAPLING = register("dark_oak_sapling", new BlockSapling(new WorldGenMegaTreeProviderDarkOak(), BlockBase.Info.of().mapColor(MaterialMapColor.PLANT).noCollission().randomTicks().instabreak().sound(SoundEffectType.GRASS).pushReaction(EnumPistonReaction.DESTROY)));
    public static final Block MANGROVE_PROPAGULE = register("mangrove_propagule", new MangrovePropaguleBlock(BlockBase.Info.of().mapColor(MaterialMapColor.PLANT).noCollission().randomTicks().instabreak().sound(SoundEffectType.GRASS).offsetType(BlockBase.EnumRandomOffset.XZ).pushReaction(EnumPistonReaction.DESTROY)));
    ...
    public static final Block SAND = register("sand", new BlockSand(14406560, BlockBase.Info.of().mapColor(MaterialMapColor.SAND).instrument(BlockPropertyInstrument.SNARE).strength(0.5F).sound(SoundEffectType.SAND)));
    public static final Block SUSPICIOUS_SAND = register("suspicious_sand", new BrushableBlock(Blocks.SAND, BlockBase.Info.of().mapColor(MaterialMapColor.SAND).instrument(BlockPropertyInstrument.SNARE).strength(0.25F).sound(SoundEffectType.SUSPICIOUS_SAND).pushReaction(EnumPistonReaction.DESTROY), SoundEffects.BRUSH_SAND, SoundEffects.BRUSH_SAND_COMPLETED));
    public static final Block RED_SAND = register("red_sand", new BlockSand(11098145, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_ORANGE).instrument(BlockPropertyInstrument.SNARE).strength(0.5F).sound(SoundEffectType.SAND)));
    public static final Block GRAVEL = register("gravel", new BlockGravel(BlockBase.Info.of().mapColor(MaterialMapColor.STONE).instrument(BlockPropertyInstrument.SNARE).strength(0.6F).sound(SoundEffectType.GRAVEL)));
    public static final Block SUSPICIOUS_GRAVEL = register("suspicious_gravel", new BrushableBlock(Blocks.GRAVEL, BlockBase.Info.of().mapColor(MaterialMapColor.STONE).instrument(BlockPropertyInstrument.SNARE).strength(0.25F).sound(SoundEffectType.SUSPICIOUS_GRAVEL).pushReaction(EnumPistonReaction.DESTROY), SoundEffects.BRUSH_GRAVEL, SoundEffects.BRUSH_GRAVEL_COMPLETED));
    public static final Block GOLD_ORE = register("gold_ore", new DropExperienceBlock(BlockBase.Info.of().mapColor(MaterialMapColor.STONE).instrument(BlockPropertyInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(3.0F, 3.0F)));
    public static final Block DEEPSLATE_GOLD_ORE = register("deepslate_gold_ore", new DropExperienceBlock(BlockBase.Info.copy(Blocks.GOLD_ORE).mapColor(MaterialMapColor.DEEPSLATE).strength(4.5F, 3.0F).sound(SoundEffectType.DEEPSLATE)));
    public static final Block IRON_ORE = register("iron_ore", new DropExperienceBlock(BlockBase.Info.of().mapColor(MaterialMapColor.STONE).instrument(BlockPropertyInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(3.0F, 3.0F)));
    public static final Block DEEPSLATE_IRON_ORE = register("deepslate_iron_ore", new DropExperienceBlock(BlockBase.Info.copy(Blocks.IRON_ORE).mapColor(MaterialMapColor.DEEPSLATE).strength(4.5F, 3.0F).sound(SoundEffectType.DEEPSLATE)));
    public static final Block COAL_ORE = register("coal_ore", new DropExperienceBlock(BlockBase.Info.of().mapColor(MaterialMapColor.STONE).instrument(BlockPropertyInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(3.0F, 3.0F), UniformInt.of(0, 2)));
    public static final Block DEEPSLATE_COAL_ORE = register("deepslate_coal_ore", new DropExperienceBlock(BlockBase.Info.copy(Blocks.COAL_ORE).mapColor(MaterialMapColor.DEEPSLATE).strength(4.5F, 3.0F).sound(SoundEffectType.DEEPSLATE), UniformInt.of(0, 2)));
    public static final Block NETHER_GOLD_ORE = register("nether_gold_ore", new DropExperienceBlock(BlockBase.Info.of().mapColor(MaterialMapColor.NETHER).instrument(BlockPropertyInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(3.0F, 3.0F).sound(SoundEffectType.NETHER_GOLD_ORE), UniformInt.of(0, 1)));
    ...
    public static final Block MANGROVE_ROOTS = register("mangrove_roots", new MangroveRootsBlock(BlockBase.Info.of().mapColor(MaterialMapColor.PODZOL).instrument(BlockPropertyInstrument.BASS).strength(0.7F).randomTicks().sound(SoundEffectType.MANGROVE_ROOTS).noOcclusion().isSuffocating(Blocks::never).isViewBlocking(Blocks::never).noOcclusion().ignitedByLava()));
    ...
    public static final Block SPONGE = register("sponge", new BlockSponge(BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_YELLOW).strength(0.6F).sound(SoundEffectType.GRASS)));
    public static final Block WET_SPONGE = register("wet_sponge", new BlockWetSponge(BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_YELLOW).strength(0.6F).sound(SoundEffectType.GRASS)));
    public static final Block GLASS = register("glass", new BlockGlass(BlockBase.Info.of().instrument(BlockPropertyInstrument.HAT).strength(0.3F).sound(SoundEffectType.GLASS).noOcclusion().isValidSpawn(Blocks::never).isRedstoneConductor(Blocks::never).isSuffocating(Blocks::never).isViewBlocking(Blocks::never)));
    public static final Block LAPIS_ORE = register("lapis_ore", new DropExperienceBlock(BlockBase.Info.of().mapColor(MaterialMapColor.STONE).instrument(BlockPropertyInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(3.0F, 3.0F), UniformInt.of(2, 5)));
    public static final Block DEEPSLATE_LAPIS_ORE = register("deepslate_lapis_ore", new DropExperienceBlock(BlockBase.Info.copy(Blocks.LAPIS_ORE).mapColor(MaterialMapColor.DEEPSLATE).strength(4.5F, 3.0F).sound(SoundEffectType.DEEPSLATE), UniformInt.of(2, 5)));
    ...
    public static final Block GRASS = register("grass", new BlockLongGrass(BlockBase.Info.of().mapColor(MaterialMapColor.PLANT).replaceable().noCollission().instabreak().sound(SoundEffectType.GRASS).offsetType(BlockBase.EnumRandomOffset.XYZ).ignitedByLava().pushReaction(EnumPistonReaction.DESTROY)));
    ...
    public static final Block WITHER_ROSE = register("wither_rose", new BlockWitherRose(MobEffects.WITHER, BlockBase.Info.of().mapColor(MaterialMapColor.PLANT).noCollission().instabreak().sound(SoundEffectType.GRASS).offsetType(BlockBase.EnumRandomOffset.XZ).pushReaction(EnumPistonReaction.DESTROY)));
    ...
    public static final Block BROWN_MUSHROOM = register("brown_mushroom", new BlockMushroom(BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_BROWN).noCollission().randomTicks().instabreak().sound(SoundEffectType.GRASS).lightLevel((iblockdata) -> {
        return 1;
    }).hasPostProcess(Blocks::always).pushReaction(EnumPistonReaction.DESTROY), TreeFeatures.HUGE_BROWN_MUSHROOM));
    public static final Block RED_MUSHROOM = register("red_mushroom", new BlockMushroom(BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_RED).noCollission().randomTicks().instabreak().sound(SoundEffectType.GRASS).hasPostProcess(Blocks::always).pushReaction(EnumPistonReaction.DESTROY), TreeFeatures.HUGE_RED_MUSHROOM));
    ...
    public static final Block TORCH = register("torch", new BlockTorch(BlockBase.Info.of().noCollission().instabreak().lightLevel((iblockdata) -> {
        return 14;
    }).sound(SoundEffectType.WOOD).pushReaction(EnumPistonReaction.DESTROY), Particles.FLAME));
    public static final Block WALL_TORCH = register("wall_torch", new BlockTorchWall(BlockBase.Info.of().noCollission().instabreak().lightLevel((iblockdata) -> {
        return 14;
    }).sound(SoundEffectType.WOOD).dropsLike(Blocks.TORCH).pushReaction(EnumPistonReaction.DESTROY), Particles.FLAME));
    ...
    public static final Block DIAMOND_ORE = register("diamond_ore", new DropExperienceBlock(BlockBase.Info.of().mapColor(MaterialMapColor.STONE).instrument(BlockPropertyInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(3.0F, 3.0F), UniformInt.of(3, 7)));
    public static final Block DEEPSLATE_DIAMOND_ORE = register("deepslate_diamond_ore", new DropExperienceBlock(BlockBase.Info.copy(Blocks.DIAMOND_ORE).mapColor(MaterialMapColor.DEEPSLATE).strength(4.5F, 3.0F).sound(SoundEffectType.DEEPSLATE), UniformInt.of(3, 7)));
    ...
    public static final Block OAK_SIGN = register("oak_sign", new BlockFloorSign(BlockBase.Info.of().mapColor(MaterialMapColor.WOOD).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollission().strength(1.0F).ignitedByLava(), BlockPropertyWood.OAK));
    public static final Block SPRUCE_SIGN = register("spruce_sign", new BlockFloorSign(BlockBase.Info.of().mapColor(Blocks.SPRUCE_LOG.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollission().strength(1.0F).ignitedByLava(), BlockPropertyWood.SPRUCE));
    public static final Block BIRCH_SIGN = register("birch_sign", new BlockFloorSign(BlockBase.Info.of().mapColor(MaterialMapColor.SAND).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollission().strength(1.0F).ignitedByLava(), BlockPropertyWood.BIRCH));
    public static final Block ACACIA_SIGN = register("acacia_sign", new BlockFloorSign(BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_ORANGE).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollission().strength(1.0F).ignitedByLava(), BlockPropertyWood.ACACIA));
    public static final Block CHERRY_SIGN = register("cherry_sign", new BlockFloorSign(BlockBase.Info.of().mapColor(Blocks.CHERRY_PLANKS.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollission().strength(1.0F).ignitedByLava(), BlockPropertyWood.CHERRY));
    public static final Block JUNGLE_SIGN = register("jungle_sign", new BlockFloorSign(BlockBase.Info.of().mapColor(Blocks.JUNGLE_LOG.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollission().strength(1.0F).ignitedByLava(), BlockPropertyWood.JUNGLE));
    public static final Block DARK_OAK_SIGN = register("dark_oak_sign", new BlockFloorSign(BlockBase.Info.of().mapColor(Blocks.DARK_OAK_LOG.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollission().strength(1.0F).ignitedByLava(), BlockPropertyWood.DARK_OAK));
    public static final Block MANGROVE_SIGN = register("mangrove_sign", new BlockFloorSign(BlockBase.Info.of().mapColor(Blocks.MANGROVE_LOG.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollission().strength(1.0F).ignitedByLava(), BlockPropertyWood.MANGROVE));
    public static final Block BAMBOO_SIGN = register("bamboo_sign", new BlockFloorSign(BlockBase.Info.of().mapColor(Blocks.BAMBOO_PLANKS.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollission().strength(1.0F).ignitedByLava(), BlockPropertyWood.BAMBOO));
    public static final Block OAK_DOOR = register("oak_door", new BlockDoor(BlockBase.Info.of().mapColor(Blocks.OAK_PLANKS.defaultMapColor()).instrument(BlockPropertyInstrument.BASS).strength(3.0F).noOcclusion().ignitedByLava().pushReaction(EnumPistonReaction.DESTROY), BlockSetType.OAK));
    ...
    public static final Block OAK_WALL_SIGN = register("oak_wall_sign", new BlockWallSign(BlockBase.Info.of().mapColor(MaterialMapColor.WOOD).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollission().strength(1.0F).dropsLike(Blocks.OAK_SIGN).ignitedByLava(), BlockPropertyWood.OAK));
    public static final Block SPRUCE_WALL_SIGN = register("spruce_wall_sign", new BlockWallSign(BlockBase.Info.of().mapColor(Blocks.SPRUCE_LOG.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollission().strength(1.0F).dropsLike(Blocks.SPRUCE_SIGN).ignitedByLava(), BlockPropertyWood.SPRUCE));
    public static final Block BIRCH_WALL_SIGN = register("birch_wall_sign", new BlockWallSign(BlockBase.Info.of().mapColor(MaterialMapColor.SAND).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollission().strength(1.0F).dropsLike(Blocks.BIRCH_SIGN).ignitedByLava(), BlockPropertyWood.BIRCH));
    public static final Block ACACIA_WALL_SIGN = register("acacia_wall_sign", new BlockWallSign(BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_ORANGE).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollission().strength(1.0F).dropsLike(Blocks.ACACIA_SIGN).ignitedByLava(), BlockPropertyWood.ACACIA));
    public static final Block CHERRY_WALL_SIGN = register("cherry_wall_sign", new BlockWallSign(BlockBase.Info.of().mapColor(Blocks.CHERRY_LOG.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollission().strength(1.0F).dropsLike(Blocks.CHERRY_SIGN).ignitedByLava(), BlockPropertyWood.CHERRY));
    public static final Block JUNGLE_WALL_SIGN = register("jungle_wall_sign", new BlockWallSign(BlockBase.Info.of().mapColor(Blocks.JUNGLE_LOG.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollission().strength(1.0F).dropsLike(Blocks.JUNGLE_SIGN).ignitedByLava(), BlockPropertyWood.JUNGLE));
    public static final Block DARK_OAK_WALL_SIGN = register("dark_oak_wall_sign", new BlockWallSign(BlockBase.Info.of().mapColor(Blocks.DARK_OAK_LOG.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollission().strength(1.0F).dropsLike(Blocks.DARK_OAK_SIGN).ignitedByLava(), BlockPropertyWood.DARK_OAK));
    public static final Block MANGROVE_WALL_SIGN = register("mangrove_wall_sign", new BlockWallSign(BlockBase.Info.of().mapColor(Blocks.MANGROVE_LOG.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollission().strength(1.0F).dropsLike(Blocks.MANGROVE_SIGN).ignitedByLava(), BlockPropertyWood.MANGROVE));
    public static final Block BAMBOO_WALL_SIGN = register("bamboo_wall_sign", new BlockWallSign(BlockBase.Info.of().mapColor(Blocks.BAMBOO_PLANKS.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollission().strength(1.0F).ignitedByLava().dropsLike(Blocks.BAMBOO_SIGN), BlockPropertyWood.BAMBOO));
    public static final Block OAK_HANGING_SIGN = register("oak_hanging_sign", new CeilingHangingSignBlock(BlockBase.Info.of().mapColor(Blocks.OAK_LOG.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollission().strength(1.0F).ignitedByLava(), BlockPropertyWood.OAK));
    public static final Block SPRUCE_HANGING_SIGN = register("spruce_hanging_sign", new CeilingHangingSignBlock(BlockBase.Info.of().mapColor(Blocks.SPRUCE_LOG.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollission().strength(1.0F).ignitedByLava(), BlockPropertyWood.SPRUCE));
    public static final Block BIRCH_HANGING_SIGN = register("birch_hanging_sign", new CeilingHangingSignBlock(BlockBase.Info.of().mapColor(MaterialMapColor.SAND).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollission().strength(1.0F).ignitedByLava(), BlockPropertyWood.BIRCH));
    public static final Block ACACIA_HANGING_SIGN = register("acacia_hanging_sign", new CeilingHangingSignBlock(BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_ORANGE).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollission().strength(1.0F).ignitedByLava(), BlockPropertyWood.ACACIA));
    public static final Block CHERRY_HANGING_SIGN = register("cherry_hanging_sign", new CeilingHangingSignBlock(BlockBase.Info.of().mapColor(MaterialMapColor.TERRACOTTA_PINK).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollission().strength(1.0F).ignitedByLava(), BlockPropertyWood.CHERRY));
    public static final Block JUNGLE_HANGING_SIGN = register("jungle_hanging_sign", new CeilingHangingSignBlock(BlockBase.Info.of().mapColor(Blocks.JUNGLE_LOG.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollission().strength(1.0F).ignitedByLava(), BlockPropertyWood.JUNGLE));
    public static final Block DARK_OAK_HANGING_SIGN = register("dark_oak_hanging_sign", new CeilingHangingSignBlock(BlockBase.Info.of().mapColor(Blocks.DARK_OAK_LOG.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollission().strength(1.0F).ignitedByLava(), BlockPropertyWood.DARK_OAK));
    public static final Block CRIMSON_HANGING_SIGN = register("crimson_hanging_sign", new CeilingHangingSignBlock(BlockBase.Info.of().mapColor(MaterialMapColor.CRIMSON_STEM).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollission().strength(1.0F), BlockPropertyWood.CRIMSON));
    public static final Block WARPED_HANGING_SIGN = register("warped_hanging_sign", new CeilingHangingSignBlock(BlockBase.Info.of().mapColor(MaterialMapColor.WARPED_STEM).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollission().strength(1.0F), BlockPropertyWood.WARPED));
    public static final Block MANGROVE_HANGING_SIGN = register("mangrove_hanging_sign", new CeilingHangingSignBlock(BlockBase.Info.of().mapColor(Blocks.MANGROVE_LOG.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollission().strength(1.0F).ignitedByLava(), BlockPropertyWood.MANGROVE));
    public static final Block BAMBOO_HANGING_SIGN = register("bamboo_hanging_sign", new CeilingHangingSignBlock(BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_YELLOW).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollission().strength(1.0F).ignitedByLava(), BlockPropertyWood.BAMBOO));
    public static final Block OAK_WALL_HANGING_SIGN = register("oak_wall_hanging_sign", new WallHangingSignBlock(BlockBase.Info.of().mapColor(Blocks.OAK_LOG.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollission().strength(1.0F).ignitedByLava().dropsLike(Blocks.OAK_HANGING_SIGN), BlockPropertyWood.OAK));
    public static final Block SPRUCE_WALL_HANGING_SIGN = register("spruce_wall_hanging_sign", new WallHangingSignBlock(BlockBase.Info.of().mapColor(MaterialMapColor.WOOD).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollission().strength(1.0F).dropsLike(Blocks.SPRUCE_HANGING_SIGN).ignitedByLava(), BlockPropertyWood.SPRUCE));
    public static final Block BIRCH_WALL_HANGING_SIGN = register("birch_wall_hanging_sign", new WallHangingSignBlock(BlockBase.Info.of().mapColor(MaterialMapColor.SAND).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollission().strength(1.0F).dropsLike(Blocks.BIRCH_HANGING_SIGN).ignitedByLava(), BlockPropertyWood.BIRCH));
    public static final Block ACACIA_WALL_HANGING_SIGN = register("acacia_wall_hanging_sign", new WallHangingSignBlock(BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_ORANGE).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollission().strength(1.0F).ignitedByLava().dropsLike(Blocks.ACACIA_HANGING_SIGN), BlockPropertyWood.ACACIA));
    public static final Block CHERRY_WALL_HANGING_SIGN = register("cherry_wall_hanging_sign", new WallHangingSignBlock(BlockBase.Info.of().mapColor(MaterialMapColor.TERRACOTTA_PINK).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollission().strength(1.0F).ignitedByLava().dropsLike(Blocks.CHERRY_HANGING_SIGN), BlockPropertyWood.CHERRY));
    public static final Block JUNGLE_WALL_HANGING_SIGN = register("jungle_wall_hanging_sign", new WallHangingSignBlock(BlockBase.Info.of().mapColor(Blocks.JUNGLE_LOG.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollission().strength(1.0F).ignitedByLava().dropsLike(Blocks.JUNGLE_HANGING_SIGN), BlockPropertyWood.JUNGLE));
    public static final Block DARK_OAK_WALL_HANGING_SIGN = register("dark_oak_wall_hanging_sign", new WallHangingSignBlock(BlockBase.Info.of().mapColor(Blocks.DARK_OAK_LOG.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollission().strength(1.0F).ignitedByLava().dropsLike(Blocks.DARK_OAK_HANGING_SIGN), BlockPropertyWood.DARK_OAK));
    public static final Block MANGROVE_WALL_HANGING_SIGN = register("mangrove_wall_hanging_sign", new WallHangingSignBlock(BlockBase.Info.of().mapColor(Blocks.MANGROVE_LOG.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollission().strength(1.0F).ignitedByLava().dropsLike(Blocks.MANGROVE_HANGING_SIGN), BlockPropertyWood.MANGROVE));
    public static final Block CRIMSON_WALL_HANGING_SIGN = register("crimson_wall_hanging_sign", new WallHangingSignBlock(BlockBase.Info.of().mapColor(MaterialMapColor.CRIMSON_STEM).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollission().strength(1.0F).dropsLike(Blocks.CRIMSON_HANGING_SIGN), BlockPropertyWood.CRIMSON));
    public static final Block WARPED_WALL_HANGING_SIGN = register("warped_wall_hanging_sign", new WallHangingSignBlock(BlockBase.Info.of().mapColor(MaterialMapColor.WARPED_STEM).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollission().strength(1.0F).dropsLike(Blocks.WARPED_HANGING_SIGN), BlockPropertyWood.WARPED));
    ...
    public static final Block LEVER = register("lever", new BlockLever(BlockBase.Info.of().noCollission().strength(0.5F).sound(SoundEffectType.WOOD).pushReaction(EnumPistonReaction.DESTROY)));
    public static final Block STONE_PRESSURE_PLATE = register("stone_pressure_plate", new BlockPressurePlateBinary(BlockPressurePlateBinary.EnumMobType.MOBS, BlockBase.Info.of().mapColor(MaterialMapColor.STONE).forceSolidOn().instrument(BlockPropertyInstrument.BASEDRUM).requiresCorrectToolForDrops().noCollission().strength(0.5F).pushReaction(EnumPistonReaction.DESTROY), BlockSetType.STONE));
    public static final Block IRON_DOOR = register("iron_door", new BlockDoor(BlockBase.Info.of().mapColor(MaterialMapColor.METAL).requiresCorrectToolForDrops().strength(5.0F).noOcclusion().pushReaction(EnumPistonReaction.DESTROY), BlockSetType.IRON));
    public static final Block OAK_PRESSURE_PLATE = register("oak_pressure_plate", new BlockPressurePlateBinary(BlockPressurePlateBinary.EnumMobType.EVERYTHING, BlockBase.Info.of().mapColor(Blocks.OAK_PLANKS.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollission().strength(0.5F).ignitedByLava().pushReaction(EnumPistonReaction.DESTROY), BlockSetType.OAK));
    public static final Block SPRUCE_PRESSURE_PLATE = register("spruce_pressure_plate", new BlockPressurePlateBinary(BlockPressurePlateBinary.EnumMobType.EVERYTHING, BlockBase.Info.of().mapColor(Blocks.SPRUCE_PLANKS.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollission().strength(0.5F).ignitedByLava().pushReaction(EnumPistonReaction.DESTROY), BlockSetType.SPRUCE));
    public static final Block BIRCH_PRESSURE_PLATE = register("birch_pressure_plate", new BlockPressurePlateBinary(BlockPressurePlateBinary.EnumMobType.EVERYTHING, BlockBase.Info.of().mapColor(Blocks.BIRCH_PLANKS.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollission().strength(0.5F).ignitedByLava().pushReaction(EnumPistonReaction.DESTROY), BlockSetType.BIRCH));
    public static final Block JUNGLE_PRESSURE_PLATE = register("jungle_pressure_plate", new BlockPressurePlateBinary(BlockPressurePlateBinary.EnumMobType.EVERYTHING, BlockBase.Info.of().mapColor(Blocks.JUNGLE_PLANKS.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollission().strength(0.5F).ignitedByLava().pushReaction(EnumPistonReaction.DESTROY), BlockSetType.JUNGLE));
    public static final Block ACACIA_PRESSURE_PLATE = register("acacia_pressure_plate", new BlockPressurePlateBinary(BlockPressurePlateBinary.EnumMobType.EVERYTHING, BlockBase.Info.of().mapColor(Blocks.ACACIA_PLANKS.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollission().strength(0.5F).ignitedByLava().pushReaction(EnumPistonReaction.DESTROY), BlockSetType.ACACIA));
    public static final Block CHERRY_PRESSURE_PLATE = register("cherry_pressure_plate", new BlockPressurePlateBinary(BlockPressurePlateBinary.EnumMobType.EVERYTHING, BlockBase.Info.of().mapColor(Blocks.CHERRY_PLANKS.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollission().strength(0.5F).ignitedByLava().pushReaction(EnumPistonReaction.DESTROY), BlockSetType.CHERRY));
    public static final Block DARK_OAK_PRESSURE_PLATE = register("dark_oak_pressure_plate", new BlockPressurePlateBinary(BlockPressurePlateBinary.EnumMobType.EVERYTHING, BlockBase.Info.of().mapColor(Blocks.DARK_OAK_PLANKS.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollission().strength(0.5F).ignitedByLava().pushReaction(EnumPistonReaction.DESTROY), BlockSetType.DARK_OAK));
    public static final Block MANGROVE_PRESSURE_PLATE = register("mangrove_pressure_plate", new BlockPressurePlateBinary(BlockPressurePlateBinary.EnumMobType.EVERYTHING, BlockBase.Info.of().mapColor(Blocks.MANGROVE_PLANKS.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollission().strength(0.5F).ignitedByLava().pushReaction(EnumPistonReaction.DESTROY), BlockSetType.MANGROVE));
    public static final Block BAMBOO_PRESSURE_PLATE = register("bamboo_pressure_plate", new BlockPressurePlateBinary(BlockPressurePlateBinary.EnumMobType.EVERYTHING, BlockBase.Info.of().mapColor(Blocks.BAMBOO_PLANKS.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollission().strength(0.5F).ignitedByLava().pushReaction(EnumPistonReaction.DESTROY), BlockSetType.BAMBOO));
    ...
    public static final Block DEEPSLATE_REDSTONE_ORE = register("deepslate_redstone_ore", new BlockRedstoneOre(BlockBase.Info.copy(Blocks.REDSTONE_ORE).mapColor(MaterialMapColor.DEEPSLATE).strength(4.5F, 3.0F).sound(SoundEffectType.DEEPSLATE)));
    ...
    public static final Block JUKEBOX = register("jukebox", new BlockJukeBox(BlockBase.Info.of().mapColor(MaterialMapColor.DIRT).instrument(BlockPropertyInstrument.BASS).strength(2.0F, 6.0F).ignitedByLava()));
    ...
    public static final Block PUMPKIN = register("pumpkin", new BlockPumpkin(BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_ORANGE).instrument(BlockPropertyInstrument.DIDGERIDOO).strength(1.0F).sound(SoundEffectType.WOOD).pushReaction(EnumPistonReaction.DESTROY)));
    ...
    public static final Block SOUL_TORCH = register("soul_torch", new BlockTorch(BlockBase.Info.of().noCollission().instabreak().lightLevel((iblockdata) -> {
        return 10;
    }).sound(SoundEffectType.WOOD).pushReaction(EnumPistonReaction.DESTROY), Particles.SOUL_FIRE_FLAME));
    public static final Block SOUL_WALL_TORCH = register("soul_wall_torch", new BlockTorchWall(BlockBase.Info.of().noCollission().instabreak().lightLevel((iblockdata) -> {
        return 10;
    }).sound(SoundEffectType.WOOD).dropsLike(Blocks.SOUL_TORCH).pushReaction(EnumPistonReaction.DESTROY), Particles.SOUL_FIRE_FLAME));
    ...
    public static final Block REPEATER = register("repeater", new BlockRepeater(BlockBase.Info.of().instabreak().sound(SoundEffectType.WOOD).pushReaction(EnumPistonReaction.DESTROY)));
    ...
    public static final Block OAK_TRAPDOOR = register("oak_trapdoor", new BlockTrapdoor(BlockBase.Info.of().mapColor(MaterialMapColor.WOOD).instrument(BlockPropertyInstrument.BASS).strength(3.0F).noOcclusion().isValidSpawn(Blocks::never).ignitedByLava(), BlockSetType.OAK));
    public static final Block SPRUCE_TRAPDOOR = register("spruce_trapdoor", new BlockTrapdoor(BlockBase.Info.of().mapColor(MaterialMapColor.PODZOL).instrument(BlockPropertyInstrument.BASS).strength(3.0F).noOcclusion().isValidSpawn(Blocks::never).ignitedByLava(), BlockSetType.SPRUCE));
    public static final Block BIRCH_TRAPDOOR = register("birch_trapdoor", new BlockTrapdoor(BlockBase.Info.of().mapColor(MaterialMapColor.SAND).instrument(BlockPropertyInstrument.BASS).strength(3.0F).noOcclusion().isValidSpawn(Blocks::never).ignitedByLava(), BlockSetType.BIRCH));
    public static final Block JUNGLE_TRAPDOOR = register("jungle_trapdoor", new BlockTrapdoor(BlockBase.Info.of().mapColor(MaterialMapColor.DIRT).instrument(BlockPropertyInstrument.BASS).strength(3.0F).noOcclusion().isValidSpawn(Blocks::never).ignitedByLava(), BlockSetType.JUNGLE));
    public static final Block ACACIA_TRAPDOOR = register("acacia_trapdoor", new BlockTrapdoor(BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_ORANGE).instrument(BlockPropertyInstrument.BASS).strength(3.0F).noOcclusion().isValidSpawn(Blocks::never).ignitedByLava(), BlockSetType.ACACIA));
    public static final Block CHERRY_TRAPDOOR = register("cherry_trapdoor", new BlockTrapdoor(BlockBase.Info.of().mapColor(MaterialMapColor.TERRACOTTA_WHITE).instrument(BlockPropertyInstrument.BASS).strength(3.0F).noOcclusion().isValidSpawn(Blocks::never).ignitedByLava(), BlockSetType.CHERRY));
    public static final Block DARK_OAK_TRAPDOOR = register("dark_oak_trapdoor", new BlockTrapdoor(BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_BROWN).instrument(BlockPropertyInstrument.BASS).strength(3.0F).noOcclusion().isValidSpawn(Blocks::never).ignitedByLava(), BlockSetType.DARK_OAK));
    public static final Block MANGROVE_TRAPDOOR = register("mangrove_trapdoor", new BlockTrapdoor(BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_RED).instrument(BlockPropertyInstrument.BASS).strength(3.0F).noOcclusion().isValidSpawn(Blocks::never).ignitedByLava(), BlockSetType.MANGROVE));
    public static final Block BAMBOO_TRAPDOOR = register("bamboo_trapdoor", new BlockTrapdoor(BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_YELLOW).instrument(BlockPropertyInstrument.BASS).strength(3.0F).noOcclusion().isValidSpawn(Blocks::never).ignitedByLava(), BlockSetType.BAMBOO));
    ...
    public static final Block MELON = register("melon", new BlockMelon(BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_LIGHT_GREEN).strength(1.0F).sound(SoundEffectType.WOOD).pushReaction(EnumPistonReaction.DESTROY)));
    ...
    public static final Block OAK_FENCE_GATE = register("oak_fence_gate", new BlockFenceGate(BlockBase.Info.of().mapColor(Blocks.OAK_PLANKS.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).strength(2.0F, 3.0F).ignitedByLava(), BlockPropertyWood.OAK));
    ...
    public static final Block EMERALD_ORE = register("emerald_ore", new DropExperienceBlock(BlockBase.Info.of().mapColor(MaterialMapColor.STONE).instrument(BlockPropertyInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(3.0F, 3.0F), UniformInt.of(3, 7)));
    public static final Block DEEPSLATE_EMERALD_ORE = register("deepslate_emerald_ore", new DropExperienceBlock(BlockBase.Info.copy(Blocks.EMERALD_ORE).mapColor(MaterialMapColor.DEEPSLATE).strength(4.5F, 3.0F).sound(SoundEffectType.DEEPSLATE), UniformInt.of(3, 7)));
    ...
    public static final Block TRIPWIRE_HOOK = register("tripwire_hook", new BlockTripwireHook(BlockBase.Info.of().noCollission().pushReaction(EnumPistonReaction.DESTROY)));
    public static final Block TRIPWIRE = register("tripwire", new BlockTripwire((BlockTripwireHook) Blocks.TRIPWIRE_HOOK, BlockBase.Info.of().noCollission().pushReaction(EnumPistonReaction.DESTROY)));
    ...
    public static final Block COMMAND_BLOCK = register("command_block", new BlockCommand(BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_BROWN).requiresCorrectToolForDrops().strength(-1.0F, 3600000.0F).noLootTable(), false));
    ...
    public static final Block COBBLESTONE_WALL = register("cobblestone_wall", new BlockCobbleWall(BlockBase.Info.copy(Blocks.COBBLESTONE).forceSolidOn()));
    public static final Block MOSSY_COBBLESTONE_WALL = register("mossy_cobblestone_wall", new BlockCobbleWall(BlockBase.Info.copy(Blocks.COBBLESTONE).forceSolidOn()));
    ...
    public static final Block LIGHT_WEIGHTED_PRESSURE_PLATE = register("light_weighted_pressure_plate", new BlockPressurePlateWeighted(15, BlockBase.Info.of().mapColor(MaterialMapColor.GOLD).forceSolidOn().requiresCorrectToolForDrops().noCollission().strength(0.5F).pushReaction(EnumPistonReaction.DESTROY), BlockSetType.GOLD));
    public static final Block HEAVY_WEIGHTED_PRESSURE_PLATE = register("heavy_weighted_pressure_plate", new BlockPressurePlateWeighted(150, BlockBase.Info.of().mapColor(MaterialMapColor.METAL).forceSolidOn().requiresCorrectToolForDrops().noCollission().strength(0.5F).pushReaction(EnumPistonReaction.DESTROY), BlockSetType.IRON));
    public static final Block COMPARATOR = register("comparator", new BlockRedstoneComparator(BlockBase.Info.of().instabreak().sound(SoundEffectType.WOOD).pushReaction(EnumPistonReaction.DESTROY)));
    ...
    public static final Block NETHER_QUARTZ_ORE = register("nether_quartz_ore", new DropExperienceBlock(BlockBase.Info.of().mapColor(MaterialMapColor.NETHER).instrument(BlockPropertyInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(3.0F, 3.0F).sound(SoundEffectType.NETHER_ORE), UniformInt.of(2, 5)));
    ...
    public static final Block BARRIER = register("barrier", new BlockBarrier(BlockBase.Info.of().strength(-1.0F, 3600000.8F).noLootTable().noOcclusion().isValidSpawn(Blocks::never).noParticlesOnBreak().pushReaction(EnumPistonReaction.BLOCK)));
    ...
    public static final Block IRON_TRAPDOOR = register("iron_trapdoor", new BlockTrapdoor(BlockBase.Info.of().mapColor(MaterialMapColor.METAL).requiresCorrectToolForDrops().strength(5.0F).noOcclusion().isValidSpawn(Blocks::never), BlockSetType.IRON));
    ...
    public static final Block SPRUCE_FENCE_GATE = register("spruce_fence_gate", new BlockFenceGate(BlockBase.Info.of().mapColor(Blocks.SPRUCE_PLANKS.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).strength(2.0F, 3.0F).ignitedByLava(), BlockPropertyWood.SPRUCE));
    public static final Block BIRCH_FENCE_GATE = register("birch_fence_gate", new BlockFenceGate(BlockBase.Info.of().mapColor(Blocks.BIRCH_PLANKS.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).strength(2.0F, 3.0F).ignitedByLava(), BlockPropertyWood.BIRCH));
    public static final Block JUNGLE_FENCE_GATE = register("jungle_fence_gate", new BlockFenceGate(BlockBase.Info.of().mapColor(Blocks.JUNGLE_PLANKS.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).strength(2.0F, 3.0F).ignitedByLava(), BlockPropertyWood.JUNGLE));
    public static final Block ACACIA_FENCE_GATE = register("acacia_fence_gate", new BlockFenceGate(BlockBase.Info.of().mapColor(Blocks.ACACIA_PLANKS.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).strength(2.0F, 3.0F).ignitedByLava(), BlockPropertyWood.ACACIA));
    public static final Block CHERRY_FENCE_GATE = register("cherry_fence_gate", new BlockFenceGate(BlockBase.Info.of().mapColor(Blocks.CHERRY_PLANKS.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).strength(2.0F, 3.0F).ignitedByLava(), BlockPropertyWood.CHERRY));
    public static final Block DARK_OAK_FENCE_GATE = register("dark_oak_fence_gate", new BlockFenceGate(BlockBase.Info.of().mapColor(Blocks.DARK_OAK_PLANKS.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).strength(2.0F, 3.0F).ignitedByLava(), BlockPropertyWood.DARK_OAK));
    public static final Block MANGROVE_FENCE_GATE = register("mangrove_fence_gate", new BlockFenceGate(BlockBase.Info.of().mapColor(Blocks.MANGROVE_PLANKS.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).strength(2.0F, 3.0F).ignitedByLava(), BlockPropertyWood.MANGROVE));
    public static final Block BAMBOO_FENCE_GATE = register("bamboo_fence_gate", new BlockFenceGate(BlockBase.Info.of().mapColor(Blocks.BAMBOO_PLANKS.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).strength(2.0F, 3.0F).ignitedByLava(), BlockPropertyWood.BAMBOO));
    ...
    public static final Block SPRUCE_DOOR = register("spruce_door", new BlockDoor(BlockBase.Info.of().mapColor(Blocks.SPRUCE_PLANKS.defaultMapColor()).instrument(BlockPropertyInstrument.BASS).strength(3.0F).noOcclusion().ignitedByLava().pushReaction(EnumPistonReaction.DESTROY), BlockSetType.SPRUCE));
    public static final Block BIRCH_DOOR = register("birch_door", new BlockDoor(BlockBase.Info.of().mapColor(Blocks.BIRCH_PLANKS.defaultMapColor()).instrument(BlockPropertyInstrument.BASS).strength(3.0F).noOcclusion().ignitedByLava().pushReaction(EnumPistonReaction.DESTROY), BlockSetType.BIRCH));
    public static final Block JUNGLE_DOOR = register("jungle_door", new BlockDoor(BlockBase.Info.of().mapColor(Blocks.JUNGLE_PLANKS.defaultMapColor()).instrument(BlockPropertyInstrument.BASS).strength(3.0F).noOcclusion().ignitedByLava().pushReaction(EnumPistonReaction.DESTROY), BlockSetType.JUNGLE));
    public static final Block ACACIA_DOOR = register("acacia_door", new BlockDoor(BlockBase.Info.of().mapColor(Blocks.ACACIA_PLANKS.defaultMapColor()).instrument(BlockPropertyInstrument.BASS).strength(3.0F).noOcclusion().ignitedByLava().pushReaction(EnumPistonReaction.DESTROY), BlockSetType.ACACIA));
    public static final Block CHERRY_DOOR = register("cherry_door", new BlockDoor(BlockBase.Info.of().mapColor(Blocks.CHERRY_PLANKS.defaultMapColor()).instrument(BlockPropertyInstrument.BASS).strength(3.0F).noOcclusion().ignitedByLava().pushReaction(EnumPistonReaction.DESTROY), BlockSetType.CHERRY));
    public static final Block DARK_OAK_DOOR = register("dark_oak_door", new BlockDoor(BlockBase.Info.of().mapColor(Blocks.DARK_OAK_PLANKS.defaultMapColor()).instrument(BlockPropertyInstrument.BASS).strength(3.0F).noOcclusion().ignitedByLava().pushReaction(EnumPistonReaction.DESTROY), BlockSetType.DARK_OAK));
    public static final Block MANGROVE_DOOR = register("mangrove_door", new BlockDoor(BlockBase.Info.of().mapColor(Blocks.MANGROVE_PLANKS.defaultMapColor()).instrument(BlockPropertyInstrument.BASS).strength(3.0F).noOcclusion().ignitedByLava().pushReaction(EnumPistonReaction.DESTROY), BlockSetType.MANGROVE));
    public static final Block BAMBOO_DOOR = register("bamboo_door", new BlockDoor(BlockBase.Info.of().mapColor(Blocks.BAMBOO_PLANKS.defaultMapColor()).instrument(BlockPropertyInstrument.BASS).strength(3.0F).noOcclusion().ignitedByLava().pushReaction(EnumPistonReaction.DESTROY), BlockSetType.BAMBOO));
    ...
    public static final Block REPEATING_COMMAND_BLOCK = register("repeating_command_block", new BlockCommand(BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_PURPLE).requiresCorrectToolForDrops().strength(-1.0F, 3600000.0F).noLootTable(), false));
    public static final Block CHAIN_COMMAND_BLOCK = register("chain_command_block", new BlockCommand(BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_GREEN).requiresCorrectToolForDrops().strength(-1.0F, 3600000.0F).noLootTable(), true));
    ...
    public static final Block STRUCTURE_VOID = register("structure_void", new BlockStructureVoid(BlockBase.Info.of().replaceable().noCollission().noLootTable().noParticlesOnBreak().pushReaction(EnumPistonReaction.DESTROY)));
    ...
    public static final Block SHULKER_BOX = register("shulker_box", shulkerBox((EnumColor) null, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_PURPLE)));
    public static final Block WHITE_SHULKER_BOX = register("white_shulker_box", shulkerBox(EnumColor.WHITE, BlockBase.Info.of().mapColor(MaterialMapColor.SNOW)));
    public static final Block ORANGE_SHULKER_BOX = register("orange_shulker_box", shulkerBox(EnumColor.ORANGE, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_ORANGE)));
    public static final Block MAGENTA_SHULKER_BOX = register("magenta_shulker_box", shulkerBox(EnumColor.MAGENTA, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_MAGENTA)));
    public static final Block LIGHT_BLUE_SHULKER_BOX = register("light_blue_shulker_box", shulkerBox(EnumColor.LIGHT_BLUE, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_LIGHT_BLUE)));
    public static final Block YELLOW_SHULKER_BOX = register("yellow_shulker_box", shulkerBox(EnumColor.YELLOW, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_YELLOW)));
    public static final Block LIME_SHULKER_BOX = register("lime_shulker_box", shulkerBox(EnumColor.LIME, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_LIGHT_GREEN)));
    public static final Block PINK_SHULKER_BOX = register("pink_shulker_box", shulkerBox(EnumColor.PINK, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_PINK)));
    public static final Block GRAY_SHULKER_BOX = register("gray_shulker_box", shulkerBox(EnumColor.GRAY, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_GRAY)));
    public static final Block LIGHT_GRAY_SHULKER_BOX = register("light_gray_shulker_box", shulkerBox(EnumColor.LIGHT_GRAY, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_LIGHT_GRAY)));
    public static final Block CYAN_SHULKER_BOX = register("cyan_shulker_box", shulkerBox(EnumColor.CYAN, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_CYAN)));
    public static final Block PURPLE_SHULKER_BOX = register("purple_shulker_box", shulkerBox(EnumColor.PURPLE, BlockBase.Info.of().mapColor(MaterialMapColor.TERRACOTTA_PURPLE)));
    public static final Block BLUE_SHULKER_BOX = register("blue_shulker_box", shulkerBox(EnumColor.BLUE, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_BLUE)));
    public static final Block BROWN_SHULKER_BOX = register("brown_shulker_box", shulkerBox(EnumColor.BROWN, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_BROWN)));
    public static final Block GREEN_SHULKER_BOX = register("green_shulker_box", shulkerBox(EnumColor.GREEN, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_GREEN)));
    public static final Block RED_SHULKER_BOX = register("red_shulker_box", shulkerBox(EnumColor.RED, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_RED)));
    public static final Block BLACK_SHULKER_BOX = register("black_shulker_box", shulkerBox(EnumColor.BLACK, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_BLACK)));
    ...
    public static final Block BRICK_WALL = register("brick_wall", new BlockCobbleWall(BlockBase.Info.copy(Blocks.BRICKS).forceSolidOn()));
    public static final Block PRISMARINE_WALL = register("prismarine_wall", new BlockCobbleWall(BlockBase.Info.copy(Blocks.PRISMARINE).forceSolidOn()));
    public static final Block RED_SANDSTONE_WALL = register("red_sandstone_wall", new BlockCobbleWall(BlockBase.Info.copy(Blocks.RED_SANDSTONE).forceSolidOn()));
    public static final Block MOSSY_STONE_BRICK_WALL = register("mossy_stone_brick_wall", new BlockCobbleWall(BlockBase.Info.copy(Blocks.MOSSY_STONE_BRICKS).forceSolidOn()));
    public static final Block GRANITE_WALL = register("granite_wall", new BlockCobbleWall(BlockBase.Info.copy(Blocks.GRANITE).forceSolidOn()));
    public static final Block STONE_BRICK_WALL = register("stone_brick_wall", new BlockCobbleWall(BlockBase.Info.copy(Blocks.STONE_BRICKS).forceSolidOn()));
    public static final Block MUD_BRICK_WALL = register("mud_brick_wall", new BlockCobbleWall(BlockBase.Info.copy(Blocks.MUD_BRICKS).forceSolidOn()));
    public static final Block NETHER_BRICK_WALL = register("nether_brick_wall", new BlockCobbleWall(BlockBase.Info.copy(Blocks.NETHER_BRICKS).forceSolidOn()));
    public static final Block ANDESITE_WALL = register("andesite_wall", new BlockCobbleWall(BlockBase.Info.copy(Blocks.ANDESITE).forceSolidOn()));
    public static final Block RED_NETHER_BRICK_WALL = register("red_nether_brick_wall", new BlockCobbleWall(BlockBase.Info.copy(Blocks.RED_NETHER_BRICKS).forceSolidOn()));
    public static final Block SANDSTONE_WALL = register("sandstone_wall", new BlockCobbleWall(BlockBase.Info.copy(Blocks.SANDSTONE).forceSolidOn()));
    public static final Block END_STONE_BRICK_WALL = register("end_stone_brick_wall", new BlockCobbleWall(BlockBase.Info.copy(Blocks.END_STONE_BRICKS).forceSolidOn()));
    public static final Block DIORITE_WALL = register("diorite_wall", new BlockCobbleWall(BlockBase.Info.copy(Blocks.DIORITE).forceSolidOn()));
    ...
    public static final Block WARPED_FUNGUS = register("warped_fungus", new BlockFungi(BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_CYAN).instabreak().noCollission().sound(SoundEffectType.FUNGUS).pushReaction(EnumPistonReaction.DESTROY), TreeFeatures.WARPED_FUNGUS_PLANTED, Blocks.WARPED_NYLIUM));
    ...
    public static final Block CRIMSON_FUNGUS = register("crimson_fungus", new BlockFungi(BlockBase.Info.of().mapColor(MaterialMapColor.NETHER).instabreak().noCollission().sound(SoundEffectType.FUNGUS).pushReaction(EnumPistonReaction.DESTROY), TreeFeatures.CRIMSON_FUNGUS_PLANTED, Blocks.CRIMSON_NYLIUM));
    ...
    public static final Block CRIMSON_PRESSURE_PLATE = register("crimson_pressure_plate", new BlockPressurePlateBinary(BlockPressurePlateBinary.EnumMobType.EVERYTHING, BlockBase.Info.of().mapColor(Blocks.CRIMSON_PLANKS.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollission().strength(0.5F).pushReaction(EnumPistonReaction.DESTROY), BlockSetType.CRIMSON));
    public static final Block WARPED_PRESSURE_PLATE = register("warped_pressure_plate", new BlockPressurePlateBinary(BlockPressurePlateBinary.EnumMobType.EVERYTHING, BlockBase.Info.of().mapColor(Blocks.WARPED_PLANKS.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).noCollission().strength(0.5F).pushReaction(EnumPistonReaction.DESTROY), BlockSetType.WARPED));
    ...
    public static final Block CRIMSON_TRAPDOOR = register("crimson_trapdoor", new BlockTrapdoor(BlockBase.Info.of().mapColor(Blocks.CRIMSON_PLANKS.defaultMapColor()).instrument(BlockPropertyInstrument.BASS).strength(3.0F).noOcclusion().isValidSpawn(Blocks::never), BlockSetType.CRIMSON));
    public static final Block WARPED_TRAPDOOR = register("warped_trapdoor", new BlockTrapdoor(BlockBase.Info.of().mapColor(Blocks.WARPED_PLANKS.defaultMapColor()).instrument(BlockPropertyInstrument.BASS).strength(3.0F).noOcclusion().isValidSpawn(Blocks::never), BlockSetType.WARPED));
    public static final Block CRIMSON_FENCE_GATE = register("crimson_fence_gate", new BlockFenceGate(BlockBase.Info.of().mapColor(Blocks.CRIMSON_PLANKS.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).strength(2.0F, 3.0F), BlockPropertyWood.CRIMSON));
    public static final Block WARPED_FENCE_GATE = register("warped_fence_gate", new BlockFenceGate(BlockBase.Info.of().mapColor(Blocks.WARPED_PLANKS.defaultMapColor()).forceSolidOn().instrument(BlockPropertyInstrument.BASS).strength(2.0F, 3.0F), BlockPropertyWood.WARPED));
    ...
    public static final Block CRIMSON_DOOR = register("crimson_door", new BlockDoor(BlockBase.Info.of().mapColor(Blocks.CRIMSON_PLANKS.defaultMapColor()).instrument(BlockPropertyInstrument.BASS).strength(3.0F).noOcclusion().pushReaction(EnumPistonReaction.DESTROY), BlockSetType.CRIMSON));
    public static final Block WARPED_DOOR = register("warped_door", new BlockDoor(BlockBase.Info.of().mapColor(Blocks.WARPED_PLANKS.defaultMapColor()).instrument(BlockPropertyInstrument.BASS).strength(3.0F).noOcclusion().pushReaction(EnumPistonReaction.DESTROY), BlockSetType.WARPED));
    public static final Block CRIMSON_SIGN = register("crimson_sign", new BlockFloorSign(BlockBase.Info.of().mapColor(Blocks.CRIMSON_PLANKS.defaultMapColor()).instrument(BlockPropertyInstrument.BASS).forceSolidOn().noCollission().strength(1.0F), BlockPropertyWood.CRIMSON));
    public static final Block WARPED_SIGN = register("warped_sign", new BlockFloorSign(BlockBase.Info.of().mapColor(Blocks.WARPED_PLANKS.defaultMapColor()).instrument(BlockPropertyInstrument.BASS).forceSolidOn().noCollission().strength(1.0F), BlockPropertyWood.WARPED));
    public static final Block CRIMSON_WALL_SIGN = register("crimson_wall_sign", new BlockWallSign(BlockBase.Info.of().mapColor(Blocks.CRIMSON_PLANKS.defaultMapColor()).instrument(BlockPropertyInstrument.BASS).forceSolidOn().noCollission().strength(1.0F).dropsLike(Blocks.CRIMSON_SIGN), BlockPropertyWood.CRIMSON));
    public static final Block WARPED_WALL_SIGN = register("warped_wall_sign", new BlockWallSign(BlockBase.Info.of().mapColor(Blocks.WARPED_PLANKS.defaultMapColor()).instrument(BlockPropertyInstrument.BASS).forceSolidOn().noCollission().strength(1.0F).dropsLike(Blocks.WARPED_SIGN), BlockPropertyWood.WARPED));
    ...
    public static final Block BLACKSTONE_WALL = register("blackstone_wall", new BlockCobbleWall(BlockBase.Info.copy(Blocks.BLACKSTONE).forceSolidOn()));
    ...
    public static final Block POLISHED_BLACKSTONE_BRICK_WALL = register("polished_blackstone_brick_wall", new BlockCobbleWall(BlockBase.Info.copy(Blocks.POLISHED_BLACKSTONE_BRICKS).forceSolidOn()));
    ...
    public static final Block POLISHED_BLACKSTONE_PRESSURE_PLATE = register("polished_blackstone_pressure_plate", new BlockPressurePlateBinary(BlockPressurePlateBinary.EnumMobType.MOBS, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_BLACK).forceSolidOn().instrument(BlockPropertyInstrument.BASEDRUM).requiresCorrectToolForDrops().noCollission().strength(0.5F).pushReaction(EnumPistonReaction.DESTROY), BlockSetType.POLISHED_BLACKSTONE));
    public static final Block POLISHED_BLACKSTONE_BUTTON = register("polished_blackstone_button", stoneButton());
    public static final Block POLISHED_BLACKSTONE_WALL = register("polished_blackstone_wall", new BlockCobbleWall(BlockBase.Info.copy(Blocks.POLISHED_BLACKSTONE).forceSolidOn()));
    ...
    public static final Block AMETHYST_CLUSTER = register("amethyst_cluster", new AmethystClusterBlock(7, 3, BlockBase.Info.of().mapColor(MaterialMapColor.COLOR_PURPLE).forceSolidOn().noOcclusion().randomTicks().sound(SoundEffectType.AMETHYST_CLUSTER).strength(1.5F).lightLevel((iblockdata) -> {
        return 5;
    }).pushReaction(EnumPistonReaction.DESTROY)));
    public static final Block LARGE_AMETHYST_BUD = register("large_amethyst_bud", new AmethystClusterBlock(5, 3, BlockBase.Info.copy(Blocks.AMETHYST_CLUSTER).sound(SoundEffectType.MEDIUM_AMETHYST_BUD).forceSolidOn().lightLevel((iblockdata) -> {
        return 4;
    }).pushReaction(EnumPistonReaction.DESTROY)));
    public static final Block MEDIUM_AMETHYST_BUD = register("medium_amethyst_bud", new AmethystClusterBlock(4, 3, BlockBase.Info.copy(Blocks.AMETHYST_CLUSTER).sound(SoundEffectType.LARGE_AMETHYST_BUD).forceSolidOn().lightLevel((iblockdata) -> {
        return 2;
    }).pushReaction(EnumPistonReaction.DESTROY)));
    public static final Block SMALL_AMETHYST_BUD = register("small_amethyst_bud", new AmethystClusterBlock(3, 4, BlockBase.Info.copy(Blocks.AMETHYST_CLUSTER).sound(SoundEffectType.SMALL_AMETHYST_BUD).forceSolidOn().lightLevel((iblockdata) -> {
        return 1;
    }).pushReaction(EnumPistonReaction.DESTROY)));
    ...
    public static final Block TINTED_GLASS = register("tinted_glass", new TintedGlassBlock(BlockBase.Info.copy(Blocks.GLASS).mapColor(MaterialMapColor.COLOR_GRAY).noOcclusion().isValidSpawn(Blocks::never).isRedstoneConductor(Blocks::never).isSuffocating(Blocks::never).isViewBlocking(Blocks::never)));
    ...
    public static final Block CALIBRATED_SCULK_SENSOR = register("calibrated_sculk_sensor", new CalibratedSculkSensorBlock(BlockBase.Info.copy(Blocks.SCULK_SENSOR)));
    ...
    public static final Block OXIDIZED_COPPER = register("oxidized_copper", new WeatheringCopperFullBlock(WeatheringCopper.a.OXIDIZED, BlockBase.Info.of().mapColor(MaterialMapColor.WARPED_NYLIUM).requiresCorrectToolForDrops().strength(3.0F, 6.0F).sound(SoundEffectType.COPPER)));
    public static final Block WEATHERED_COPPER = register("weathered_copper", new WeatheringCopperFullBlock(WeatheringCopper.a.WEATHERED, BlockBase.Info.of().mapColor(MaterialMapColor.WARPED_STEM).requiresCorrectToolForDrops().strength(3.0F, 6.0F).sound(SoundEffectType.COPPER)));
    public static final Block EXPOSED_COPPER = register("exposed_copper", new WeatheringCopperFullBlock(WeatheringCopper.a.EXPOSED, BlockBase.Info.of().mapColor(MaterialMapColor.TERRACOTTA_LIGHT_GRAY).requiresCorrectToolForDrops().strength(3.0F, 6.0F).sound(SoundEffectType.COPPER)));
    ...
    public static final Block DEEPSLATE_COPPER_ORE = register("deepslate_copper_ore", new DropExperienceBlock(BlockBase.Info.copy(Blocks.COPPER_ORE).mapColor(MaterialMapColor.DEEPSLATE).strength(4.5F, 3.0F).sound(SoundEffectType.DEEPSLATE)));
    ...
    public static final Block MUD = register("mud", new MudBlock(BlockBase.Info.copy(Blocks.DIRT).mapColor(MaterialMapColor.TERRACOTTA_CYAN).isValidSpawn(Blocks::always).isRedstoneConductor(Blocks::always).isViewBlocking(Blocks::always).isSuffocating(Blocks::always).sound(SoundEffectType.MUD)));
    ...
    public static final Block COBBLED_DEEPSLATE_WALL = register("cobbled_deepslate_wall", new BlockCobbleWall(BlockBase.Info.copy(Blocks.COBBLED_DEEPSLATE).forceSolidOn()));
    ...
    public static final Block POLISHED_DEEPSLATE_WALL = register("polished_deepslate_wall", new BlockCobbleWall(BlockBase.Info.copy(Blocks.POLISHED_DEEPSLATE).forceSolidOn()));
    ...
    public static final Block DEEPSLATE_TILE_WALL = register("deepslate_tile_wall", new BlockCobbleWall(BlockBase.Info.copy(Blocks.DEEPSLATE_TILES).forceSolidOn()));
    ...
    public static final Block DEEPSLATE_BRICK_WALL = register("deepslate_brick_wall", new BlockCobbleWall(BlockBase.Info.copy(Blocks.DEEPSLATE_BRICKS).forceSolidOn()));
    ...
    private static BlockRotatable log(MaterialMapColor materialmapcolor, MaterialMapColor materialmapcolor1, SoundEffectType soundeffecttype) {
        return new BlockRotatable(BlockBase.Info.of().mapColor((iblockdata) -> {
            return iblockdata.getValue(BlockRotatable.AXIS) == EnumDirection.EnumAxis.Y ? materialmapcolor : materialmapcolor1;
    ...
    private static BlockShulkerBox shulkerBox(EnumColor enumcolor, BlockBase.Info blockbase_info) {
        ...
        return new BlockShulkerBox(enumcolor, blockbase_info.forceSolidOn().strength(2.0F).dynamicShape().noOcclusion().isSuffocating(blockbase_f).isViewBlocking(blockbase_f).pushReaction(EnumPistonReaction.DESTROY).isRedstoneConductor(Blocks::always));
    }
    ...
    private static BlockButtonAbstract woodenButton(BlockSetType blocksettype, FeatureFlag... afeatureflag) {
        BlockBase.Info blockbase_info = BlockBase.Info.of().noCollission().strength(0.5F).pushReaction(EnumPistonReaction.DESTROY);

        if (afeatureflag.length > 0) {
            blockbase_info = blockbase_info.requiredFeatures(afeatureflag);
        }

        return new BlockButtonAbstract(blockbase_info, blocksettype, 30, true);
    }

    private static BlockButtonAbstract stoneButton() {
        return new BlockButtonAbstract(BlockBase.Info.of().noCollission().strength(0.5F).pushReaction(EnumPistonReaction.DESTROY), BlockSetType.STONE, 20, false);
    }

    private static BlockFlowerPot flowerPot(Block block, FeatureFlag... afeatureflag) {
        BlockBase.Info blockbase_info = BlockBase.Info.of().instabreak().noOcclusion().pushReaction(EnumPistonReaction.DESTROY);

        if (afeatureflag.length > 0) {
            blockbase_info = blockbase_info.requiredFeatures(afeatureflag);
        }

        return new BlockFlowerPot(block, blockbase_info);
    }

    private static CandleBlock candle(MaterialMapColor materialmapcolor) {
