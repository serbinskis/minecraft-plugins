...
public class DefinedStructureProcessorPredicates {
    ...
    public static final Codec<DefinedStructureProcessorPredicates> CODEC = RecordCodecBuilder.create((instance) -> {
        ...
        }), RuleBlockEntityModifier.CODEC.optionalFieldOf("block_entity_modifier", DefinedStructureProcessorPredicates.DEFAULT_BLOCK_ENTITY_MODIFIER).forGetter((definedstructureprocessorpredicates) -> {
