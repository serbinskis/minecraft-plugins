...
public class CollectingNeighborUpdater implements NeighborUpdater {
    ...
    private static record d(EnumDirection direction, IBlockData state, BlockPosition pos, BlockPosition neighborPos, int updateFlags, int updateLimit) implements CollectingNeighborUpdater.c {
