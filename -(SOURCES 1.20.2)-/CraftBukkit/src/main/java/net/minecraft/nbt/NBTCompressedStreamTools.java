...
public class NBTCompressedStreamTools {
    ...
    public static void parseCompressed(File file, StreamTagVisitor streamtagvisitor, NBTReadLimiter nbtreadlimiter) throws IOException {
        FileInputStream fileinputstream = new FileInputStream(file);

        try {
            parseCompressed((InputStream) fileinputstream, streamtagvisitor, nbtreadlimiter);
        } catch (Throwable throwable) {
            try {
                fileinputstream.close();
            } catch (Throwable throwable1) {
