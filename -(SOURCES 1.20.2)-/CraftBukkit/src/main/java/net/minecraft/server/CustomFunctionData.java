...
public class CustomFunctionData {
    ...
    public int execute(CustomFunction customfunction, CommandListenerWrapper commandlistenerwrapper) {
        try {
            return this.execute(customfunction, commandlistenerwrapper, (CustomFunctionData.TraceCallbacks) null, (NBTTagCompound) null);
        } catch (FunctionInstantiationException functioninstantiationexception) {
            return 0;
        }
    }

    public int execute(CustomFunction customfunction, CommandListenerWrapper commandlistenerwrapper, @Nullable CustomFunctionData.TraceCallbacks customfunctiondata_tracecallbacks, @Nullable NBTTagCompound nbttagcompound) throws FunctionInstantiationException {
        CustomFunction customfunction1 = customfunction.instantiate(nbttagcompound, this.getDispatcher(), commandlistenerwrapper);
        ...
        if (this.context != null) {
            if (customfunctiondata_tracecallbacks != null) {
                ...
                this.context.delayFunctionCall(customfunction1, commandlistenerwrapper);
                return 0;
            }
        } else {
            int i;
            ...
            try {
                ...
                i = this.context.runTopCommand(customfunction1, commandlistenerwrapper);
            } finally {
                this.context = null;
            }
    ...
    private class ExecutionContext {
        ...
        void delayFunctionCall(CustomFunction customfunction, CommandListenerWrapper commandlistenerwrapper) {
            ...
            if (this.commandQueue.size() + this.nestedCalls.size() < i) {
                this.nestedCalls.add(new CustomFunctionData.QueuedCommand(commandlistenerwrapper1, this.depth, new CustomFunction.e(customfunction)));
            }
        ...
        int runTopCommand(CustomFunction customfunction, CommandListenerWrapper commandlistenerwrapper) {
            ...
            for (int k = acustomfunction_d.length - 1; k >= 0; --k) {
                this.commandQueue.push(new CustomFunctionData.QueuedCommand(commandlistenerwrapper1, 0, acustomfunction_d[k]));
            }
    ...
    public static class QueuedCommand {
        ...
        public QueuedCommand(CommandListenerWrapper commandlistenerwrapper, int i, CustomFunction.d customfunction_d) {
            this.sender = commandlistenerwrapper;
            this.depth = i;
            this.entry = customfunction_d;
        }
