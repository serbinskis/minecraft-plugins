        ...
        if (i == 0) {
            ...
            ((Either) pair.getSecond()).ifLeft((customfunction) -> {
                ...
                commandlistenerwrapper.sendSuccess(() -> {
                    return IChatBaseComponent.translatable("commands.schedule.created.function", minecraftkey, i, j);
                }, true);
            }).ifRight((collection) -> {
                ...
                commandlistenerwrapper.sendSuccess(() -> {
                    return IChatBaseComponent.translatable("commands.schedule.created.tag", minecraftkey, i, j);
                }, true);
            });
