...
public record CriterionConditionEntityFlags(Optional<Boolean> isOnFire, Optional<Boolean> isCrouching, Optional<Boolean> isSprinting, Optional<Boolean> isSwimming, Optional<Boolean> isBaby) {
    ...
    public static final Codec<CriterionConditionEntityFlags> CODEC = RecordCodecBuilder.create((instance) -> {
        return instance.group(ExtraCodecs.strictOptionalField(Codec.BOOL, "is_on_fire").forGetter(CriterionConditionEntityFlags::isOnFire), ExtraCodecs.strictOptionalField(Codec.BOOL, "is_sneaking").forGetter(CriterionConditionEntityFlags::isCrouching), ExtraCodecs.strictOptionalField(Codec.BOOL, "is_sprinting").forGetter(CriterionConditionEntityFlags::isSprinting), ExtraCodecs.strictOptionalField(Codec.BOOL, "is_swimming").forGetter(CriterionConditionEntityFlags::isSwimming), ExtraCodecs.strictOptionalField(Codec.BOOL, "is_baby").forGetter(CriterionConditionEntityFlags::isBaby)).apply(instance, CriterionConditionEntityFlags::new);
    });
