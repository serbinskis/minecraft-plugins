...
public record CriterionConditionLight(CriterionConditionValue.IntegerRange composite) {
    ...
    public static final Codec<CriterionConditionLight> CODEC = RecordCodecBuilder.create((instance) -> {
        return instance.group(ExtraCodecs.strictOptionalField(CriterionConditionValue.IntegerRange.CODEC, "light", CriterionConditionValue.IntegerRange.ANY).forGetter(CriterionConditionLight::composite)).apply(instance, CriterionConditionLight::new);
    });
