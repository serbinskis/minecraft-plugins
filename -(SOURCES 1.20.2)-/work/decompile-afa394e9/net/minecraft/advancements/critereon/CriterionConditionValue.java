...
public interface CriterionConditionValue<T extends Number> {
    ...
    public static record DoubleRange(Optional<Double> min, Optional<Double> max, Optional<Double> minSq, Optional<Double> maxSq) implements CriterionConditionValue<Double> {
        ...
        public static CriterionConditionValue.DoubleRange fromJson(@Nullable JsonElement jsonelement) {
            return jsonelement != null && !jsonelement.isJsonNull() ? (CriterionConditionValue.DoubleRange) SystemUtils.getOrThrow(CriterionConditionValue.DoubleRange.CODEC.parse(JsonOps.INSTANCE, jsonelement), JsonParseException::new) : CriterionConditionValue.DoubleRange.ANY;
        }

        public JsonElement serializeToJson() {
            return (JsonElement) (this.isAny() ? JsonNull.INSTANCE : (JsonElement) SystemUtils.getOrThrow(CriterionConditionValue.DoubleRange.CODEC.encodeStart(JsonOps.INSTANCE, this), IllegalStateException::new));
        }
    ...
    public static record IntegerRange(Optional<Integer> min, Optional<Integer> max, Optional<Long> minSq, Optional<Long> maxSq) implements CriterionConditionValue<Integer> {
        ...
        public static CriterionConditionValue.IntegerRange fromJson(@Nullable JsonElement jsonelement) {
            return jsonelement != null && !jsonelement.isJsonNull() ? (CriterionConditionValue.IntegerRange) SystemUtils.getOrThrow(CriterionConditionValue.IntegerRange.CODEC.parse(JsonOps.INSTANCE, jsonelement), JsonParseException::new) : CriterionConditionValue.IntegerRange.ANY;
        }

        public JsonElement serializeToJson() {
            return (JsonElement) (this.isAny() ? JsonNull.INSTANCE : (JsonElement) SystemUtils.getOrThrow(CriterionConditionValue.IntegerRange.CODEC.encodeStart(JsonOps.INSTANCE, this), IllegalStateException::new));
        }
