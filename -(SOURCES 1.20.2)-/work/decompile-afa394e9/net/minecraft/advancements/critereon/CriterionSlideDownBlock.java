...
public class CriterionSlideDownBlock extends CriterionTriggerAbstract<CriterionSlideDownBlock.a> {
    ...
    @Override
    public CriterionSlideDownBlock.a createInstance(JsonObject jsonobject, Optional<ContextAwarePredicate> optional, LootDeserializationContext lootdeserializationcontext) {
        ...
        return new CriterionSlideDownBlock.a(optional, block, optional1);
    }
    ...
    public static class a extends CriterionInstanceAbstract {
        ...
        public static Criterion<CriterionSlideDownBlock.a> slidesDownBlock(Block block) {
            return CriterionTriggers.HONEY_BLOCK_SLIDE.createCriterion(new CriterionSlideDownBlock.a(Optional.empty(), block, Optional.empty()));
        }
