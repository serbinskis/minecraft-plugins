...
public abstract class CriterionTriggerAbstract<T extends CriterionTriggerAbstract.a> implements CriterionTrigger<T> {
    ...
    protected abstract T createInstance(JsonObject jsonobject, Optional<ContextAwarePredicate> optional, LootDeserializationContext lootdeserializationcontext);

    @Override
    public final T createInstance(JsonObject jsonobject, LootDeserializationContext lootdeserializationcontext) {
        Optional<ContextAwarePredicate> optional = CriterionConditionEntity.fromJson(jsonobject, "player", lootdeserializationcontext);
