...
public class GameTestHarnessTestCommand {
    ...
    public static void register(CommandDispatcher<CommandListenerWrapper> commanddispatcher) {
        commanddispatcher.register((LiteralArgumentBuilder) ((LiteralArgumentBuilder) ((LiteralArgumentBuilder) ((LiteralArgumentBuilder) ((LiteralArgumentBuilder) ((LiteralArgumentBuilder) ((LiteralArgumentBuilder) ((LiteralArgumentBuilder) ((LiteralArgumentBuilder) ((LiteralArgumentBuilder) ((LiteralArgumentBuilder) ((LiteralArgumentBuilder) net.minecraft.commands.CommandDispatcher.literal("test").then(net.minecraft.commands.CommandDispatcher.literal("runthis").executes((commandcontext) -> {
    ...
    private static int exportAllNearbyTests(CommandListenerWrapper commandlistenerwrapper) {
        ...
        if (collection.isEmpty()) {
            ...
            while (iterator.hasNext()) {
                ...
                if (exportTestStructure(commandlistenerwrapper, s) != 0) {
                    flag = false;
                }
            }
