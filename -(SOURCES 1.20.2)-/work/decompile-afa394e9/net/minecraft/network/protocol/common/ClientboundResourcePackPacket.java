...
public class ClientboundResourcePackPacket implements Packet<ClientCommonPacketListener> {
    ...
    public ClientboundResourcePackPacket(String s, String s1, boolean flag, @Nullable IChatBaseComponent ichatbasecomponent) {
        if (s1.length() > 40) {
    ...
    public ClientboundResourcePackPacket(PacketDataSerializer packetdataserializer) {
