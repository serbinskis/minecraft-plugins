        ...
        if (i == 0) {
            ...
            if (collection.size() == 1) {
                commandlistenerwrapper.sendSuccess(() -> {
                    return IChatBaseComponent.translatable("commands.playsound.success.single", minecraftkey, ((EntityPlayer) collection.iterator().next()).getDisplayName());
                }, true);
            } else {
                commandlistenerwrapper.sendSuccess(() -> {
                    return IChatBaseComponent.translatable("commands.playsound.success.multiple", minecraftkey, collection.size());
                }, true);
            }
