        ...
        if (soundcategory != null) {
            if (minecraftkey != null) {
                commandlistenerwrapper.sendSuccess(() -> {
                    return IChatBaseComponent.translatable("commands.stopsound.success.source.sound", minecraftkey, soundcategory.getName());
                }, true);
            } else {
                commandlistenerwrapper.sendSuccess(() -> {
            ...
            commandlistenerwrapper.sendSuccess(() -> {
                return IChatBaseComponent.translatable("commands.stopsound.success.sourceless.sound", minecraftkey);
            }, true);
        } else {
            commandlistenerwrapper.sendSuccess(() -> {
