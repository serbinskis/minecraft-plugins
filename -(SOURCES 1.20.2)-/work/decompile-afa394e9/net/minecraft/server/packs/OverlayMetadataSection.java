...
public record OverlayMetadataSection(List<OverlayMetadataSection.a> overlays) {
    ...
    public static record a(InclusiveRange<Integer> format, String overlay) {
        ...
        static final Codec<OverlayMetadataSection.a> CODEC = RecordCodecBuilder.create((instance) -> {
            return instance.group(InclusiveRange.codec(Codec.INT).fieldOf("formats").forGetter(OverlayMetadataSection.a::format), ExtraCodecs.validate((Codec) Codec.STRING, OverlayMetadataSection::validateOverlayDir).fieldOf("directory").forGetter(OverlayMetadataSection.a::overlay)).apply(instance, OverlayMetadataSection.a::new);
        });
