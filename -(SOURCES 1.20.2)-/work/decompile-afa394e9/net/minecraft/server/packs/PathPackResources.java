...
public class PathPackResources extends ResourcePackAbstract {
    ...
    public static class a implements ResourcePackLoader.c {
        ...
        public IResourcePack openPrimary(String s) {
            return new PathPackResources(s, this.content, this.isBuiltin);
        }

        @Override
        public IResourcePack openFull(String s, ResourcePackLoader.a resourcepackloader_a) {
            IResourcePack iresourcepack = this.openPrimary(s);
            ...
            if (list.isEmpty()) {
                ...
                while (iterator.hasNext()) {
                    ...
                    Path path = this.content.resolve(s1);

                    list1.add(new PathPackResources(s, path, this.isBuiltin));
                }
