...
public class ResourcePackFile extends ResourcePackAbstract {
    ...
    ResourcePackFile(String s, ResourcePackFile.b resourcepackfile_b, boolean flag, String s1) {
        super(s, flag);
    ...
    public static class a implements ResourcePackLoader.c {
        ...
        public a(Path path, boolean flag) {
            this(path.toFile(), flag);
        }

        public a(File file, boolean flag) {
            this.isBuiltin = flag;
            this.content = file;
        }

        @Override
        public IResourcePack openPrimary(String s) {
            ResourcePackFile.b resourcepackfile_b = new ResourcePackFile.b(this.content);

            return new ResourcePackFile(s, resourcepackfile_b, this.isBuiltin, "");
        }

        @Override
        public IResourcePack openFull(String s, ResourcePackLoader.a resourcepackloader_a) {
            ResourcePackFile.b resourcepackfile_b = new ResourcePackFile.b(this.content);
            ResourcePackFile resourcepackfile = new ResourcePackFile(s, resourcepackfile_b, this.isBuiltin, "");
            ...
            if (list.isEmpty()) {
                ...
                while (iterator.hasNext()) {
                    ...
                    list1.add(new ResourcePackFile(s, resourcepackfile_b, this.isBuiltin, s1));
                }
