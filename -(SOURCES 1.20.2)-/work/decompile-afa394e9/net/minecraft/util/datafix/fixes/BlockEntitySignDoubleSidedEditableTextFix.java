...
public class BlockEntitySignDoubleSidedEditableTextFix extends DataConverterNamedEntity {
    ...
    private static final String EMPTY_COMPONENT = IChatBaseComponent.ChatSerializer.toJson(CommonComponents.EMPTY);
    ...
    private static <T> Dynamic<T> fixFrontTextTag(Dynamic<T> dynamic) {
        Dynamic<T> dynamic1 = dynamic.createString(BlockEntitySignDoubleSidedEditableTextFix.EMPTY_COMPONENT);
