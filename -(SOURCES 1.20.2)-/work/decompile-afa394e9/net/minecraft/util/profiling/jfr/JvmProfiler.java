...
public interface JvmProfiler {
    ...
    void onPacketReceived(EnumProtocol enumprotocol, int i, SocketAddress socketaddress, int j);

    void onPacketSent(EnumProtocol enumprotocol, int i, SocketAddress socketaddress, int j);
    ...
    public static class a implements JvmProfiler {
        ...
        @Override
        public void onPacketReceived(EnumProtocol enumprotocol, int i, SocketAddress socketaddress, int j) {}

        @Override
        public void onPacketSent(EnumProtocol enumprotocol, int i, SocketAddress socketaddress, int j) {}
