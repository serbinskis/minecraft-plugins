...
public final class NetworkPacketSummary {
    ...
    public static record b(EnumProtocolDirection direction, String protocolId, int packetId) {
        ...
        public static NetworkPacketSummary.b from(RecordedEvent recordedevent) {
            return new NetworkPacketSummary.b(recordedevent.getEventType().getName().equals("minecraft.PacketSent") ? EnumProtocolDirection.CLIENTBOUND : EnumProtocolDirection.SERVERBOUND, recordedevent.getString("protocolId"), recordedevent.getInt("packetId"));
        }
            ...
            for (int j = 0; j < i; ++j) {
                ...
                for (int l = 0; l < k; ++l) {
                    ...
                    int2objectmap.forEach((integer, oclass) -> {
                        builder.put(new NetworkPacketSummary.b(enumprotocoldirection, enumprotocol.id(), integer), oclass.getSimpleName());
                    });
                }
            }
