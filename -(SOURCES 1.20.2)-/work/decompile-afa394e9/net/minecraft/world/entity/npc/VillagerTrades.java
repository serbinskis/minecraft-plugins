...
public class VillagerTrades {
    ...
    private static ItemStack potion(PotionRegistry potionregistry) {
        return PotionUtil.setPotion(new ItemStack(Items.POTION), potionregistry);
    }
    ...
    private static class d implements VillagerTrades.IMerchantRecipeOption {
        ...
        public MerchantRecipe getOffer(Entity entity, RandomSource randomsource) {
            ...
            return new MerchantRecipe(new ItemStack(Items.EMERALD, l), new ItemStack(Items.BOOK), itemstack, 12, this.villagerXp, 0.2F);
        }
    }
    ...
    private static class b implements VillagerTrades.IMerchantRecipeOption {
        ...
        public b(IMaterial imaterial, int i, int j, int k, int l) {
            this(new ItemStack(imaterial.asItem(), i), j, k, l);
        }

        public b(ItemStack itemstack, int i, int j, int k) {
        ...
        @Override
        public MerchantRecipe getOffer(Entity entity, RandomSource randomsource) {
            return new MerchantRecipe(this.itemStack.copy(), new ItemStack(Items.EMERALD, this.emeraldAmount), this.maxUses, this.villagerXp, this.priceMultiplier);
        }
    }
    ...
    private static class i implements VillagerTrades.IMerchantRecipeOption {
        ...
        @Override
        public MerchantRecipe getOffer(Entity entity, RandomSource randomsource) {
            return new MerchantRecipe(new ItemStack(Items.EMERALD, this.emeraldCost), this.itemStack.copy(), this.maxUses, this.villagerXp, this.priceMultiplier);
        }
    }

    private static class j implements VillagerTrades.IMerchantRecipeOption {

        private final List<SuspiciousEffectHolder.a> effects;
        private final int xp;
        private final float priceMultiplier;

        public j(MobEffectList mobeffectlist, int i, int j) {
            this(List.of(new SuspiciousEffectHolder.a(mobeffectlist, i)), j, 0.05F);
        }

        public j(List<SuspiciousEffectHolder.a> list, int i, float f) {
            this.effects = list;
            this.xp = i;
            this.priceMultiplier = f;
        }
        ...
        public MerchantRecipe getOffer(Entity entity, RandomSource randomsource) {
            ...
            ItemSuspiciousStew.saveMobEffects(itemstack, this.effects);
    ...
    private static class h implements VillagerTrades.IMerchantRecipeOption {
        ...
        public h(IMaterial imaterial, int i, int j, ItemStack itemstack, int k, int l, int i1, float f) {
            this.fromItem = new ItemStack(imaterial, i);
            this.emeraldCost = j;
        ...
        @Override
        public MerchantRecipe getOffer(Entity entity, RandomSource randomsource) {
            return new MerchantRecipe(new ItemStack(Items.EMERALD, this.emeraldCost), this.fromItem.copy(), this.toItem.copy(), this.maxUses, this.villagerXp, this.priceMultiplier);
        }
    }
    ...
    private static class c implements VillagerTrades.IMerchantRecipeOption {
        ...
        public MerchantRecipe getOffer(Entity entity, RandomSource randomsource) {
            if (entity instanceof VillagerDataHolder) {
                VillagerDataHolder villagerdataholder = (VillagerDataHolder) entity;
                ItemStack itemstack = new ItemStack((IMaterial) this.trades.get(villagerdataholder.getVillagerData().getType()), this.cost);
    ...
    private static class l implements VillagerTrades.IMerchantRecipeOption {
        ...
        public l(int i, TagKey<Structure> tagkey, String s, MapIcon.Type mapicon_type, int j, int k) {
            this.emeraldCost = i;
