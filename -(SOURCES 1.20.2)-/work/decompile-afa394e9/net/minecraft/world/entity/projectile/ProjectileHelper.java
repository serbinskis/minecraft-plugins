...
public final class ProjectileHelper {
    ...
    public static MovingObjectPosition getHitResultOnMoveVector(Entity entity, Predicate<Entity> predicate) {
        ...
        return getHitResult(vec3d1, entity, predicate, vec3d, world);
    }
    ...
    private static MovingObjectPosition getHitResult(Vec3D vec3d, Entity entity, Predicate<Entity> predicate, Vec3D vec3d1, World world) {
        Vec3D vec3d2 = vec3d.add(vec3d1);
        Object object = world.clip(new RayTrace(vec3d, vec3d2, RayTrace.BlockCollisionOption.COLLIDER, RayTrace.FluidCollisionOption.NONE, entity));
        ...
        MovingObjectPositionEntity movingobjectpositionentity = getEntityHitResult(world, entity, vec3d, vec3d2, entity.getBoundingBox().expandTowards(vec3d1).inflate(1.0D), predicate);
