...
public class PotionBrewer {
    ...
    protected static boolean isContainerIngredient(ItemStack itemstack) {
        Iterator iterator = PotionBrewer.CONTAINER_MIXES.iterator();
    ...
    protected static boolean isPotionIngredient(ItemStack itemstack) {
        Iterator iterator = PotionBrewer.POTION_MIXES.iterator();
    ...
    public static boolean isBrewablePotion(PotionRegistry potionregistry) {
        ...
        do {
            ...
            potionbrewer_predicatedcombination = (PotionBrewer.PredicatedCombination) iterator.next();
        } while (potionbrewer_predicatedcombination.to != potionregistry);
    ...
    protected static boolean hasContainerMix(ItemStack itemstack, ItemStack itemstack1) {
        ...
        do {
            ...
            potionbrewer_predicatedcombination = (PotionBrewer.PredicatedCombination) iterator.next();
        } while (potionbrewer_predicatedcombination.from != item || !potionbrewer_predicatedcombination.ingredient.test(itemstack1));
    ...
    protected static boolean hasPotionMix(ItemStack itemstack, ItemStack itemstack1) {
        ...
        do {
            ...
            potionbrewer_predicatedcombination = (PotionBrewer.PredicatedCombination) iterator.next();
        } while (potionbrewer_predicatedcombination.from != potionregistry || !potionbrewer_predicatedcombination.ingredient.test(itemstack1));
    ...
    public static ItemStack mix(ItemStack itemstack, ItemStack itemstack1) {
        if (!itemstack1.isEmpty()) {
            ...
            iterator = PotionBrewer.POTION_MIXES.iterator();
