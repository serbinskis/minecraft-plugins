...
public class PotionRegistry {
    ...
    private final Holder.c<PotionRegistry> builtInRegistryHolder;
    ...
    public PotionRegistry(@Nullable String s, MobEffect... amobeffect) {
        this.builtInRegistryHolder = BuiltInRegistries.POTION.createIntrusiveHolder(this);
        this.name = s;
    ...
    /** @deprecated */
    @Deprecated
    public Holder.c<PotionRegistry> builtInRegistryHolder() {
