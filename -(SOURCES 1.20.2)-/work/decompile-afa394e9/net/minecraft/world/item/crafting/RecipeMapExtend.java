...
public class RecipeMapExtend extends ShapedRecipes {
    ...
    public RecipeMapExtend(CraftingBookCategory craftingbookcategory) {
        super("", craftingbookcategory, 3, 3, NonNullList.of(RecipeItemStack.EMPTY, RecipeItemStack.of(Items.PAPER), RecipeItemStack.of(Items.PAPER), RecipeItemStack.of(Items.PAPER), RecipeItemStack.of(Items.PAPER), RecipeItemStack.of(Items.FILLED_MAP), RecipeItemStack.of(Items.PAPER), RecipeItemStack.of(Items.PAPER), RecipeItemStack.of(Items.PAPER), RecipeItemStack.of(Items.PAPER)), new ItemStack(Items.MAP));
    }
