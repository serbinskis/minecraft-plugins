...
public class Blocks {
    ...
    private static BlockShulkerBox shulkerBox(EnumColor enumcolor, BlockBase.Info blockbase_info) {
        ...
        return new BlockShulkerBox(enumcolor, blockbase_info.forceSolidOn().strength(2.0F).dynamicShape().noOcclusion().isSuffocating(blockbase_f).isViewBlocking(blockbase_f).pushReaction(EnumPistonReaction.DESTROY));
    }
    ...
    public static Block register(MinecraftKey minecraftkey, Block block) {
        return (Block) IRegistry.register(BuiltInRegistries.BLOCK, minecraftkey, block);
    }
