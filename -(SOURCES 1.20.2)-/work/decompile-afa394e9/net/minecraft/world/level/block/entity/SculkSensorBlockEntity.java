...
public class SculkSensorBlockEntity extends TileEntity implements GameEventListener.b<VibrationSystem.b>, VibrationSystem {
    ...
    protected class a implements VibrationSystem.d {
        ...
        public boolean canReceiveVibration(WorldServer worldserver, BlockPosition blockposition, GameEvent gameevent, @Nullable GameEvent.a gameevent_a) {
            return blockposition.equals(this.blockPos) && (gameevent == GameEvent.BLOCK_DESTROY || gameevent == GameEvent.BLOCK_PLACE) ? false : SculkSensorBlock.canActivate(SculkSensorBlockEntity.this.getBlockState());
        }
