...
public class GameEvent {
    ...
    private static GameEvent register(String s, int i) {
        return (GameEvent) IRegistry.register(BuiltInRegistries.GAME_EVENT, s, new GameEvent(i));
    }

    public String toString() {
        MinecraftKey minecraftkey = this.builtInRegistryHolder().key().location();

        return "Game Event{ " + minecraftkey + " , " + this.notificationRadius + "}";
    }
