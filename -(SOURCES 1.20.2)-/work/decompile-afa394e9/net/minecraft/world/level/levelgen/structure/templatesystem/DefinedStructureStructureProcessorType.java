...
public interface DefinedStructureStructureProcessorType<P extends DefinedStructureProcessor> {
    ...
    Codec<ProcessorList> DIRECT_CODEC = ExtraCodecs.withAlternative(DefinedStructureStructureProcessorType.LIST_OBJECT_CODEC.fieldOf("processors").codec(), DefinedStructureStructureProcessorType.LIST_OBJECT_CODEC);
