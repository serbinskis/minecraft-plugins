...
public class IntRange {
    ...
    private static final Codec<IntRange> RECORD_CODEC = RecordCodecBuilder.create((instance) -> {
        return instance.group(ExtraCodecs.strictOptionalField(NumberProviders.CODEC, "min").forGetter((intrange) -> {
            return Optional.ofNullable(intrange.min);
        }), ExtraCodecs.strictOptionalField(NumberProviders.CODEC, "max").forGetter((intrange) -> {
