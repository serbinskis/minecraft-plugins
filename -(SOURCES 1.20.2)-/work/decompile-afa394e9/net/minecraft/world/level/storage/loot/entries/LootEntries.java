...
public class LootEntries {
    ...
    private static LootEntryType register(String s, Codec<? extends LootEntryAbstract> codec) {
        return (LootEntryType) IRegistry.register(BuiltInRegistries.LOOT_POOL_ENTRY_TYPE, new MinecraftKey(s), new LootEntryType(codec));
    }
}
