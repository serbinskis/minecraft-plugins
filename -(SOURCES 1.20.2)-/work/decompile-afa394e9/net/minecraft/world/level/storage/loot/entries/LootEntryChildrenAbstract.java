...
public abstract class LootEntryChildrenAbstract extends LootEntryAbstract {
    ...
    public static <T extends LootEntryChildrenAbstract> Codec<T> createCodec(LootEntryChildrenAbstract.a<T> lootentrychildrenabstract_a) {
        return RecordCodecBuilder.create((instance) -> {
            P2 p2 = instance.group(ExtraCodecs.strictOptionalField(LootEntries.CODEC.listOf(), "children", List.of()).forGetter((lootentrychildrenabstract) -> {
