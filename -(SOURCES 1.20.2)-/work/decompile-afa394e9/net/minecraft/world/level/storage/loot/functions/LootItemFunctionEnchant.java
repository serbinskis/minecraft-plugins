...
public class LootItemFunctionEnchant extends LootItemFunctionConditional {
    ...
    public static final Codec<LootItemFunctionEnchant> CODEC = RecordCodecBuilder.create((instance) -> {
        return commonFields(instance).and(ExtraCodecs.strictOptionalField(LootItemFunctionEnchant.ENCHANTMENT_SET_CODEC, "enchantments").forGetter((lootitemfunctionenchant) -> {
