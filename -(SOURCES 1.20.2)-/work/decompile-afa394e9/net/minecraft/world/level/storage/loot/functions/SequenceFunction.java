...
public class SequenceFunction implements LootItemFunction {
    ...
    public static final Codec<SequenceFunction> CODEC = RecordCodecBuilder.create((instance) -> {
        return instance.group(LootItemFunctions.CODEC.listOf().fieldOf("functions").forGetter((sequencefunction) -> {
            return sequencefunction.functions;
        })).apply(instance, SequenceFunction::new);
    });
    public static final Codec<SequenceFunction> INLINE_CODEC = LootItemFunctions.CODEC.listOf().xmap(SequenceFunction::new, (sequencefunction) -> {
        return sequencefunction.functions;
    });
