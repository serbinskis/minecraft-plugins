...
public record LootItemConditionDamageSourceProperties(Optional<CriterionConditionDamageSource> predicate) implements LootItemCondition {
    ...
    public static final Codec<LootItemConditionDamageSourceProperties> CODEC = RecordCodecBuilder.create((instance) -> {
        return instance.group(ExtraCodecs.strictOptionalField(CriterionConditionDamageSource.CODEC, "predicate").forGetter(LootItemConditionDamageSourceProperties::predicate)).apply(instance, LootItemConditionDamageSourceProperties::new);
    });
