...
public record LootItemConditionEntityProperty(Optional<CriterionConditionEntity> predicate, LootTableInfo.EntityTarget entityTarget) implements LootItemCondition {
    ...
    public static final Codec<LootItemConditionEntityProperty> CODEC = RecordCodecBuilder.create((instance) -> {
        return instance.group(ExtraCodecs.strictOptionalField(CriterionConditionEntity.CODEC, "predicate").forGetter(LootItemConditionEntityProperty::predicate), LootTableInfo.EntityTarget.CODEC.fieldOf("entity").forGetter(LootItemConditionEntityProperty::entityTarget)).apply(instance, LootItemConditionEntityProperty::new);
    });
