...
public record LootItemConditionInverted(LootItemCondition term) implements LootItemCondition {
    ...
    public static final Codec<LootItemConditionInverted> CODEC = RecordCodecBuilder.create((instance) -> {
        return instance.group(LootItemConditions.CODEC.fieldOf("term").forGetter(LootItemConditionInverted::term)).apply(instance, LootItemConditionInverted::new);
    });
