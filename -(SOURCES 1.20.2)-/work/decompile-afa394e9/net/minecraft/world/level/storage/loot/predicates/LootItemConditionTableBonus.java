...
public record LootItemConditionTableBonus(Holder<Enchantment> enchantment, List<Float> values) implements LootItemCondition {
    ...
    public static final Codec<LootItemConditionTableBonus> CODEC = RecordCodecBuilder.create((instance) -> {
        return instance.group(BuiltInRegistries.ENCHANTMENT.holderByNameCodec().fieldOf("enchantment").forGetter(LootItemConditionTableBonus::enchantment), Codec.FLOAT.listOf().fieldOf("chances").forGetter(LootItemConditionTableBonus::values)).apply(instance, LootItemConditionTableBonus::new);
    });
