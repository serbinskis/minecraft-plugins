...
public record LootItemConditionTimeCheck(Optional<Long> period, IntRange value) implements LootItemCondition {
    ...
    public static final Codec<LootItemConditionTimeCheck> CODEC = RecordCodecBuilder.create((instance) -> {
        return instance.group(ExtraCodecs.strictOptionalField(Codec.LONG, "period").forGetter(LootItemConditionTimeCheck::period), IntRange.CODEC.fieldOf("value").forGetter(LootItemConditionTimeCheck::value)).apply(instance, LootItemConditionTimeCheck::new);
    });
