    ...
    public LightChunk getChunkForLighting(int i, int j) {
        ...
        if (playerchunk == null) {
            ...
            while (true) {
                ...
                IChunkAccess ichunkaccess = (IChunkAccess) ((ChunkResult) playerchunk.getFutureIfPresentUnchecked(chunkstatus).getNow(PlayerChunk.UNLOADED_CHUNK)).orElse((Object) null);
