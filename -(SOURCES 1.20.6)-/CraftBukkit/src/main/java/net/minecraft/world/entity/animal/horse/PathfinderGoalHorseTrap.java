...
public class PathfinderGoalHorseTrap extends PathfinderGoal {
    ...
    private EntitySkeleton createSkeleton(DifficultyDamageScaler difficultydamagescaler, EntityHorseAbstract entityhorseabstract) {
        ...
        if (entityskeleton != null) {
            ...
            FeatureFlagSet featureflagset = entityhorseabstract.level().enabledFeatures();

            entityskeleton.setItemSlot(EnumItemSlot.MAINHAND, EnchantmentManager.enchantItem(featureflagset, entityskeleton.getRandom(), this.disenchant(entityskeleton.getMainHandItem()), (int) (5.0F + difficultydamagescaler.getSpecialMultiplier() * (float) entityskeleton.getRandom().nextInt(18)), false));
            entityskeleton.setItemSlot(EnumItemSlot.HEAD, EnchantmentManager.enchantItem(featureflagset, entityskeleton.getRandom(), this.disenchant(entityskeleton.getItemBySlot(EnumItemSlot.HEAD)), (int) (5.0F + difficultydamagescaler.getSpecialMultiplier() * (float) entityskeleton.getRandom().nextInt(18)), false));
        }
