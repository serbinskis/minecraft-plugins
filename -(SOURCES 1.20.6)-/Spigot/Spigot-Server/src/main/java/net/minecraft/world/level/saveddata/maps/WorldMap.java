...
public class WorldMap extends PersistentBase {
    ...
    public static WorldMap load(NBTTagCompound nbttagcompound, HolderLookup.a holderlookup_a) {
        ...
        for (int k = 0; k < nbttaglist.size(); ++k) {
            ...
            if (worldmapframe != null) {
                ...
                worldmap.addDecoration(MapDecorationTypes.FRAME, (GeneratorAccess) null, "frame-" + worldmapframe.getEntityId(), (double) worldmapframe.getPos().getX(), (double) worldmapframe.getPos().getZ(), (double) worldmapframe.getRotation(), (IChatBaseComponent) null);
            }
        }
    ...
    public void tickCarriedBy(EntityHuman entityhuman, ItemStack itemstack) {
        ...
        if (itemstack.isFramed() && this.trackingPosition) {
            ...
            this.addDecoration(MapDecorationTypes.FRAME, entityhuman.level(), "frame-" + entityitemframe.getId(), (double) blockposition.getX(), (double) blockposition.getZ(), (double) (entityitemframe.getDirection().get2DDataValue() * 90), (IChatBaseComponent) null);
