...
public class NetherFeatures {
    ...
    public static void bootstrap(BootstrapContext<WorldGenFeatureConfigured<?, ?>> bootstrapcontext) {
        ...
        FeatureUtils.register(bootstrapcontext, NetherFeatures.SPRING_NETHER_CLOSED, WorldGenerator.SPRING, new WorldGenFeatureHellFlowingLavaConfiguration(FluidTypes.LAVA.defaultFluidState(), false, 5, 0, HolderSet.direct(Block::builtInRegistryHolder, (Object[])(Blocks.NETHERRACK))));
        FeatureUtils.register(bootstrapcontext, NetherFeatures.SPRING_NETHER_OPEN, WorldGenerator.SPRING, new WorldGenFeatureHellFlowingLavaConfiguration(FluidTypes.LAVA.defaultFluidState(), false, 4, 1, HolderSet.direct(Block::builtInRegistryHolder, (Object[])(Blocks.NETHERRACK))));
