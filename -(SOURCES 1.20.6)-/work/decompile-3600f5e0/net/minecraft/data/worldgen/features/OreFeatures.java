...
public class OreFeatures {
    ...
    public static void bootstrap(BootstrapContext<WorldGenFeatureConfigured<?, ?>> bootstrapcontext) {
        ...
        FeatureUtils.register(bootstrapcontext, OreFeatures.ORE_MAGMA, WorldGenerator.ORE, new WorldGenFeatureOreConfiguration(definedstructuretestblock, Blocks.MAGMA_BLOCK.defaultBlockState(), 33));
        FeatureUtils.register(bootstrapcontext, OreFeatures.ORE_SOUL_SAND, WorldGenerator.ORE, new WorldGenFeatureOreConfiguration(definedstructuretestblock, Blocks.SOUL_SAND.defaultBlockState(), 12));
        FeatureUtils.register(bootstrapcontext, OreFeatures.ORE_NETHER_GOLD, WorldGenerator.ORE, new WorldGenFeatureOreConfiguration(definedstructuretestblock, Blocks.NETHER_GOLD_ORE.defaultBlockState(), 10));
        FeatureUtils.register(bootstrapcontext, OreFeatures.ORE_QUARTZ, WorldGenerator.ORE, new WorldGenFeatureOreConfiguration(definedstructuretestblock, Blocks.NETHER_QUARTZ_ORE.defaultBlockState(), 14));
        FeatureUtils.register(bootstrapcontext, OreFeatures.ORE_GRAVEL_NETHER, WorldGenerator.ORE, new WorldGenFeatureOreConfiguration(definedstructuretestblock, Blocks.GRAVEL.defaultBlockState(), 33));
        FeatureUtils.register(bootstrapcontext, OreFeatures.ORE_BLACKSTONE, WorldGenerator.ORE, new WorldGenFeatureOreConfiguration(definedstructuretestblock, Blocks.BLACKSTONE.defaultBlockState(), 33));
        FeatureUtils.register(bootstrapcontext, OreFeatures.ORE_DIRT, WorldGenerator.ORE, new WorldGenFeatureOreConfiguration(definedstructuretesttag, Blocks.DIRT.defaultBlockState(), 33));
        FeatureUtils.register(bootstrapcontext, OreFeatures.ORE_GRAVEL, WorldGenerator.ORE, new WorldGenFeatureOreConfiguration(definedstructuretesttag, Blocks.GRAVEL.defaultBlockState(), 33));
        FeatureUtils.register(bootstrapcontext, OreFeatures.ORE_GRANITE, WorldGenerator.ORE, new WorldGenFeatureOreConfiguration(definedstructuretesttag, Blocks.GRANITE.defaultBlockState(), 64));
        FeatureUtils.register(bootstrapcontext, OreFeatures.ORE_DIORITE, WorldGenerator.ORE, new WorldGenFeatureOreConfiguration(definedstructuretesttag, Blocks.DIORITE.defaultBlockState(), 64));
        FeatureUtils.register(bootstrapcontext, OreFeatures.ORE_ANDESITE, WorldGenerator.ORE, new WorldGenFeatureOreConfiguration(definedstructuretesttag, Blocks.ANDESITE.defaultBlockState(), 64));
        FeatureUtils.register(bootstrapcontext, OreFeatures.ORE_TUFF, WorldGenerator.ORE, new WorldGenFeatureOreConfiguration(definedstructuretesttag, Blocks.TUFF.defaultBlockState(), 64));
        ...
        FeatureUtils.register(bootstrapcontext, OreFeatures.ORE_ANCIENT_DEBRIS_LARGE, WorldGenerator.SCATTERED_ORE, new WorldGenFeatureOreConfiguration(definedstructuretesttag3, Blocks.ANCIENT_DEBRIS.defaultBlockState(), 3, 1.0F));
        FeatureUtils.register(bootstrapcontext, OreFeatures.ORE_ANCIENT_DEBRIS_SMALL, WorldGenerator.SCATTERED_ORE, new WorldGenFeatureOreConfiguration(definedstructuretesttag3, Blocks.ANCIENT_DEBRIS.defaultBlockState(), 2, 1.0F));
        ...
        FeatureUtils.register(bootstrapcontext, OreFeatures.ORE_CLAY, WorldGenerator.ORE, new WorldGenFeatureOreConfiguration(definedstructuretesttag, Blocks.CLAY.defaultBlockState(), 33));
    }
}
