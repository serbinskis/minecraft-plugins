...
public class GameTestHarnessTestCommand {
    ...
    public static void register(com.mojang.brigadier.CommandDispatcher<CommandListenerWrapper> com_mojang_brigadier_commanddispatcher) {
        ...
        testfinder_a = GameTestHarnessTestCommand.testFinder;
        Objects.requireNonNull(testfinder_a);
        com_mojang_brigadier_commanddispatcher.register((LiteralArgumentBuilder) ((LiteralArgumentBuilder) ((LiteralArgumentBuilder) ((LiteralArgumentBuilder) ((LiteralArgumentBuilder) ((LiteralArgumentBuilder) ((LiteralArgumentBuilder) ((LiteralArgumentBuilder) ((LiteralArgumentBuilder) ((LiteralArgumentBuilder) ((LiteralArgumentBuilder) ((LiteralArgumentBuilder) ((LiteralArgumentBuilder) ((LiteralArgumentBuilder) ((LiteralArgumentBuilder) ((LiteralArgumentBuilder) literalargumentbuilder.then(runWithRetryOptionsAndBuildInfo(argumentbuilder2, testfinder_a::failedTests))).then(CommandDispatcher.literal("locate").then(CommandDispatcher.argument("testName", GameTestHarnessTestFunctionArgument.testFunctionArgument()).executes((commandcontext) -> {
    ...
    private static boolean verifyStructureExists(WorldServer worldserver, String s) {
        if (worldserver.getStructureManager().get(new MinecraftKey(s)).isEmpty()) {
    ...
    public static class a {
        ...
        public int run(RetryOptions retryoptions, int i, int j) {
            ...
            if (collection.isEmpty()) {
                ...
                GameTestHarnessRunner gametestharnessrunner = GameTestHarnessRunner.a.fromInfo(collection, worldserver).newStructureSpawner(new StructureGridSpawner(blockposition, j)).build();
