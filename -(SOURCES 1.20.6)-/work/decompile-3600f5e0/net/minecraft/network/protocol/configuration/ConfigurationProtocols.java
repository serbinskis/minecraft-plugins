...
public class ConfigurationProtocols {
    ...
    public static final ProtocolInfo<ServerConfigurationPacketListener> SERVERBOUND = ProtocolInfoBuilder.serverboundProtocol(EnumProtocol.CONFIGURATION, (protocolinfobuilder) -> {
    ...
    public static final ProtocolInfo<ClientConfigurationPacketListener> CLIENTBOUND = ProtocolInfoBuilder.clientboundProtocol(EnumProtocol.CONFIGURATION, (protocolinfobuilder) -> {
