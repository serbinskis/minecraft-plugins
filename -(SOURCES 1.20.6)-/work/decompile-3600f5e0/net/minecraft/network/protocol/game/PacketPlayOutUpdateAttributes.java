...
public class PacketPlayOutUpdateAttributes implements Packet<PacketListenerPlayOut> {
    ...
    public static record AttributeSnapshot(Holder<AttributeBase> attribute, double base, Collection<AttributeModifier> modifiers) {
        ...
        public static final StreamCodec<ByteBuf, AttributeModifier> MODIFIER_STREAM_CODEC = StreamCodec.composite(UUIDUtil.STREAM_CODEC, AttributeModifier::id, ByteBufCodecs.DOUBLE, AttributeModifier::amount, AttributeModifier.Operation.STREAM_CODEC, AttributeModifier::operation, (uuid, odouble, attributemodifier_operation) -> {
            return new AttributeModifier(uuid, "Unknown synced attribute modifier", odouble, attributemodifier_operation);
        });
        public static final StreamCodec<RegistryFriendlyByteBuf, PacketPlayOutUpdateAttributes.AttributeSnapshot> STREAM_CODEC = StreamCodec.composite(ByteBufCodecs.holderRegistry(Registries.ATTRIBUTE), PacketPlayOutUpdateAttributes.AttributeSnapshot::attribute, ByteBufCodecs.DOUBLE, PacketPlayOutUpdateAttributes.AttributeSnapshot::base, PacketPlayOutUpdateAttributes.AttributeSnapshot.MODIFIER_STREAM_CODEC.apply(ByteBufCodecs.collection(ArrayList::new)), PacketPlayOutUpdateAttributes.AttributeSnapshot::modifiers, PacketPlayOutUpdateAttributes.AttributeSnapshot::new);
    }
}
