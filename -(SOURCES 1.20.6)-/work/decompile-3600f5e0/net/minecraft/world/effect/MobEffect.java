...
public class MobEffect implements Comparable<MobEffect> {
    ...
    public static final Codec<MobEffect> CODEC = RecordCodecBuilder.create((instance) -> {
        return instance.group(BuiltInRegistries.MOB_EFFECT.holderByNameCodec().fieldOf("id").forGetter(MobEffect::getEffect), MobEffect.b.MAP_CODEC.forGetter(MobEffect::asDetails)).apply(instance, MobEffect::new);
    });
    public static final StreamCodec<RegistryFriendlyByteBuf, MobEffect> STREAM_CODEC = StreamCodec.composite(ByteBufCodecs.holderRegistry(Registries.MOB_EFFECT), MobEffect::getEffect, MobEffect.b.STREAM_CODEC, MobEffect::asDetails, MobEffect::new);
