...
public class AnimalPanic<E extends EntityCreature> extends Behavior<E> {
    ...
    public AnimalPanic(float f) {
        Predicate predicate = AnimalPanic.DEFAULT_SHOULD_PANIC_PREDICATE;

        Objects.requireNonNull(predicate);
        this(f, predicate::test);
    }
    ...
    protected boolean checkExtraStartConditions(WorldServer worldserver, E e0) {
        return this.shouldPanic.test(e0) && (e0.getBrain().hasMemoryValue(MemoryModuleType.HURT_BY) || e0.getBrain().hasMemoryValue(MemoryModuleType.IS_PANICKING));
    }
