...
public class VillagePlace extends RegionFileSection<VillagePlaceSection> {
    ...
    public VillagePlace(RegionStorageInfo regionstorageinfo, Path path, DataFixer datafixer, boolean flag, IRegistryCustom iregistrycustom, LevelHeightAccessor levelheightaccessor) {
        super(new SimpleRegionStorage(regionstorageinfo, path, datafixer, flag, DataFixTypes.POI_CHUNK), VillagePlaceSection::codec, VillagePlaceSection::new, iregistrycustom, levelheightaccessor);
    }
