...
public class EntityFox extends EntityAnimal implements VariantHolder<EntityFox.Type> {
    ...
    public static AttributeProvider.Builder createAttributes() {
        return EntityInsentient.createMobAttributes().add(GenericAttributes.MOVEMENT_SPEED, 0.30000001192092896D).add(GenericAttributes.MAX_HEALTH, 10.0D).add(GenericAttributes.FOLLOW_RANGE, 32.0D).add(GenericAttributes.ATTACK_DAMAGE, 2.0D).add(GenericAttributes.SAFE_FALL_DISTANCE, 5.0D);
    }
