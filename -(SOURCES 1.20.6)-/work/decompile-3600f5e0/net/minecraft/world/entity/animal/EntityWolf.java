...
public class EntityWolf extends EntityTameableAnimal implements IEntityAngerable, VariantHolder<Holder<WolfVariant>> {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new EntityWolf.c(this, 1.5D));
    ...
    protected void defineSynchedData(DataWatcher.a datawatcher_a) {
        ...
        datawatcher_a.define(EntityWolf.DATA_VARIANT_ID, this.registryAccess().registryOrThrow(Registries.WOLF_VARIANT).getHolderOrThrow(WolfVariants.PALE));
    ...
    public void addAdditionalSaveData(NBTTagCompound nbttagcompound) {
        ...
        nbttagcompound.putString("variant", ((ResourceKey) this.getVariant().unwrapKey().orElse(WolfVariants.PALE)).location().toString());
    ...
    public EnumInteractionResult mobInteract(EntityHuman entityhuman, EnumHand enumhand) {
        ...
        if (this.level().isClientSide && (!this.isBaby() || !this.isFood(itemstack))) {
            ...
            if (this.isFood(itemstack) && this.getHealth() < this.getMaxHealth()) {
                ...
                if (itemstack.is(Items.WOLF_ARMOR) && this.isOwnedBy(entityhuman) && !this.hasArmor() && !this.isBaby()) {
                    ...
                    if (itemstack.is(Items.SHEARS) && this.isOwnedBy(entityhuman) && this.hasArmor() && (!EnchantmentManager.hasBindingCurse(this.getBodyArmorItem()) || entityhuman.isCreative())) {
    ...
    private class c extends PathfinderGoalPanic {

        public c(final EntityWolf entitywolf, final double d0) {
            super(entitywolf, d0);
        }
