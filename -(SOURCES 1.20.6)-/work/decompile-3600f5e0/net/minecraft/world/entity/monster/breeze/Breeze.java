...
public class Breeze extends EntityMonster {
    ...
    private static final ProjectileDeflection PROJECTILE_DEFLECTION = (iprojectile, entity, randomsource) -> {
        entity.level().playLocalSound(entity, SoundEffects.BREEZE_DEFLECT, entity.getSoundSource(), 1.0F, 1.0F);
    ...
    public ProjectileDeflection deflection(IProjectile iprojectile) {
        return iprojectile.getType() != EntityTypes.BREEZE_WIND_CHARGE && iprojectile.getType() != EntityTypes.WIND_CHARGE ? Breeze.PROJECTILE_DEFLECTION : ProjectileDeflection.NONE;
    }
