...
public abstract class EntityArrow extends IProjectile {
    ...
    public void setOwner(@Nullable Entity entity) {
        ...
        if (entity instanceof EntityHuman && this.pickup == EntityArrow.PickupStatus.DISALLOWED) {
    ...
    public void setEnchantmentEffectsFromEntity(EntityLiving entityliving, float f) {
        int i = EnchantmentManager.getEnchantmentLevel(Enchantments.POWER, entityliving);
        int j = EnchantmentManager.getEnchantmentLevel(Enchantments.PUNCH, entityliving);
        ...
        if (EnchantmentManager.getEnchantmentLevel(Enchantments.FLAME, entityliving) > 0) {
