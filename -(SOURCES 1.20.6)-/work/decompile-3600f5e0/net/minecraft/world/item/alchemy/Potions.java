...
public class Potions {
    ...
    public static final Holder<PotionRegistry> WATER = register("water", new PotionRegistry(new MobEffect[0]));
    public static final Holder<PotionRegistry> MUNDANE = register("mundane", new PotionRegistry(new MobEffect[0]));
    public static final Holder<PotionRegistry> THICK = register("thick", new PotionRegistry(new MobEffect[0]));
    public static final Holder<PotionRegistry> AWKWARD = register("awkward", new PotionRegistry(new MobEffect[0]));
    public static final Holder<PotionRegistry> NIGHT_VISION = register("night_vision", new PotionRegistry(new MobEffect[]{new MobEffect(MobEffects.NIGHT_VISION, 3600)}));
    ...
    public static final Holder<PotionRegistry> INVISIBILITY = register("invisibility", new PotionRegistry(new MobEffect[]{new MobEffect(MobEffects.INVISIBILITY, 3600)}));
    ...
    public static final Holder<PotionRegistry> LEAPING = register("leaping", new PotionRegistry(new MobEffect[]{new MobEffect(MobEffects.JUMP, 3600)}));
    ...
    public static final Holder<PotionRegistry> FIRE_RESISTANCE = register("fire_resistance", new PotionRegistry(new MobEffect[]{new MobEffect(MobEffects.FIRE_RESISTANCE, 3600)}));
    ...
    public static final Holder<PotionRegistry> SWIFTNESS = register("swiftness", new PotionRegistry(new MobEffect[]{new MobEffect(MobEffects.MOVEMENT_SPEED, 3600)}));
    ...
    public static final Holder<PotionRegistry> SLOWNESS = register("slowness", new PotionRegistry(new MobEffect[]{new MobEffect(MobEffects.MOVEMENT_SLOWDOWN, 1800)}));
    ...
    public static final Holder<PotionRegistry> WATER_BREATHING = register("water_breathing", new PotionRegistry(new MobEffect[]{new MobEffect(MobEffects.WATER_BREATHING, 3600)}));
    ...
    public static final Holder<PotionRegistry> HEALING = register("healing", new PotionRegistry(new MobEffect[]{new MobEffect(MobEffects.HEAL, 1)}));
    ...
    public static final Holder<PotionRegistry> HARMING = register("harming", new PotionRegistry(new MobEffect[]{new MobEffect(MobEffects.HARM, 1)}));
    ...
    public static final Holder<PotionRegistry> POISON = register("poison", new PotionRegistry(new MobEffect[]{new MobEffect(MobEffects.POISON, 900)}));
    ...
    public static final Holder<PotionRegistry> REGENERATION = register("regeneration", new PotionRegistry(new MobEffect[]{new MobEffect(MobEffects.REGENERATION, 900)}));
    ...
    public static final Holder<PotionRegistry> STRENGTH = register("strength", new PotionRegistry(new MobEffect[]{new MobEffect(MobEffects.DAMAGE_BOOST, 3600)}));
    ...
    public static final Holder<PotionRegistry> WEAKNESS = register("weakness", new PotionRegistry(new MobEffect[]{new MobEffect(MobEffects.WEAKNESS, 1800)}));
    ...
    public static final Holder<PotionRegistry> SLOW_FALLING = register("slow_falling", new PotionRegistry(new MobEffect[]{new MobEffect(MobEffects.SLOW_FALLING, 1800)}));
    ...
    public static final Holder<PotionRegistry> WIND_CHARGED = register("wind_charged", (new PotionRegistry("wind_charged", new MobEffect[]{new MobEffect(MobEffects.WIND_CHARGED, 3600)})).requiredFeatures(FeatureFlags.UPDATE_1_21));
    public static final Holder<PotionRegistry> WEAVING = register("weaving", (new PotionRegistry("weaving", new MobEffect[]{new MobEffect(MobEffects.WEAVING, 3600)})).requiredFeatures(FeatureFlags.UPDATE_1_21));
    public static final Holder<PotionRegistry> OOZING = register("oozing", (new PotionRegistry("oozing", new MobEffect[]{new MobEffect(MobEffects.OOZING, 3600)})).requiredFeatures(FeatureFlags.UPDATE_1_21));
    public static final Holder<PotionRegistry> INFESTED = register("infested", (new PotionRegistry("infested", new MobEffect[]{new MobEffect(MobEffects.INFESTED, 3600)})).requiredFeatures(FeatureFlags.UPDATE_1_21));

    public Potions() {}

    private static Holder<PotionRegistry> register(String s, PotionRegistry potionregistry) {
        return IRegistry.registerForHolder(BuiltInRegistries.POTION, new MinecraftKey(s), potionregistry);
    }
