...
public class ItemEnchantments implements TooltipProvider {
    ...
    private static final Codec<Object2IntOpenHashMap<Holder<Enchantment>>> LEVELS_CODEC = Codec.unboundedMap(BuiltInRegistries.ENCHANTMENT.holderByNameCodec(), ItemEnchantments.LEVEL_CODEC).xmap(Object2IntOpenHashMap::new, Function.identity());
        ...
        if (this.showInTooltip) {
            ...
            while (objectiterator.hasNext()) {
                ...
                if (!holderset.contains(holder1)) {
                    consumer.accept(((Enchantment) holder1.value()).getFullname(entry.getIntValue()));
                }
            }
