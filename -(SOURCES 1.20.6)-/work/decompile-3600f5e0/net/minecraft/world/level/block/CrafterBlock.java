...
public class CrafterBlock extends BlockTileEntity {
    ...
    protected void dispenseFrom(IBlockData iblockdata, WorldServer worldserver, BlockPosition blockposition) {
        ...
        if (tileentity instanceof CrafterBlockEntity crafterblockentity) {
            ...
            if (optional.isEmpty()) {
                ...
                ItemStack itemstack = ((RecipeCrafting) recipeholder.value()).assemble(crafterblockentity, worldserver.registryAccess());
                ...
                if (itemstack.isEmpty()) {
                    ...
                    Iterator iterator = ((RecipeCrafting) recipeholder.value()).getRemainingItems(crafterblockentity).iterator();
    ...
    public static Optional<RecipeHolder<RecipeCrafting>> getPotentialResults(World world, InventoryCrafting inventorycrafting) {
