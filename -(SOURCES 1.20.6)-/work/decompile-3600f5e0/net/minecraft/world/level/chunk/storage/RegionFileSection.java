...
public class RegionFileSection<R> implements AutoCloseable {
    ...
    public RegionFileSection(SimpleRegionStorage simpleregionstorage, Function<Runnable, Codec<R>> function, Function<Runnable, R> function1, IRegistryCustom iregistrycustom, LevelHeightAccessor levelheightaccessor) {
    ...
    private void writeColumn(ChunkCoordIntPair chunkcoordintpair) {
        ...
        if (nbtbase instanceof NBTTagCompound) {
            this.simpleRegionStorage.write(chunkcoordintpair, (NBTTagCompound) nbtbase);
        } else {
