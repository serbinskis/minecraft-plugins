...
public class NoiseRouterData {
    ...
    public static Holder<? extends DensityFunction> bootstrap(BootstrapContext<DensityFunction> bootstrapcontext) {
        HolderGetter<NoiseGeneratorNormal.a> holdergetter = bootstrapcontext.lookup(Registries.NOISE);
        HolderGetter<DensityFunction> holdergetter1 = bootstrapcontext.lookup(Registries.DENSITY_FUNCTION);
