...
public class MapDecorationTypes {
    ...
    private static Holder<MapDecorationType> register(String s, String s1, boolean flag, int i, boolean flag1, boolean flag2) {
        ResourceKey<MapDecorationType> resourcekey = ResourceKey.create(Registries.MAP_DECORATION_TYPE, new MinecraftKey(s));
        MapDecorationType mapdecorationtype = new MapDecorationType(new MinecraftKey(s1), flag, i, flag2, flag1);
