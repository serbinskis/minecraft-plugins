...
public class LootTables {
    ...
    public static final ResourceKey<LootTable> EMPTY = ResourceKey.create(Registries.LOOT_TABLE, new MinecraftKey("empty"));
    ...
    private static ResourceKey<LootTable> register(String s) {
        return register(ResourceKey.create(Registries.LOOT_TABLE, new MinecraftKey(s)));
    }
