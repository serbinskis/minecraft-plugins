...
public class LootItemFunctions {
    ...
    public static final LootItemFunctionType<LootEnchantFunction> LOOTING_ENCHANT = register("looting_enchant", LootEnchantFunction.CODEC);
    ...
    private static <T extends LootItemFunction> LootItemFunctionType<T> register(String s, MapCodec<T> mapcodec) {
        return (LootItemFunctionType) IRegistry.register(BuiltInRegistries.LOOT_FUNCTION_TYPE, new MinecraftKey(s), new LootItemFunctionType<>(mapcodec));
    }
