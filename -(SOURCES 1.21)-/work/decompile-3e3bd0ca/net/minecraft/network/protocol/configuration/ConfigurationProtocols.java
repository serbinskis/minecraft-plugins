...
public class ConfigurationProtocols {
    ...
    public static final ProtocolInfo.a<ServerConfigurationPacketListener, PacketDataSerializer> SERVERBOUND_TEMPLATE = ProtocolInfoBuilder.serverboundProtocol(EnumProtocol.CONFIGURATION, (protocolinfobuilder) -> {
    ...
    public static final ProtocolInfo.a<ClientConfigurationPacketListener, PacketDataSerializer> CLIENTBOUND_TEMPLATE = ProtocolInfoBuilder.clientboundProtocol(EnumProtocol.CONFIGURATION, (protocolinfobuilder) -> {
