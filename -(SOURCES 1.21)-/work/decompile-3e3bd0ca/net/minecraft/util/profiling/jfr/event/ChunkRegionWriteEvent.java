...
public class ChunkRegionWriteEvent extends ChunkRegionIoEvent {
    ...
    public ChunkRegionWriteEvent(RegionStorageInfo regionstorageinfo, ChunkCoordIntPair chunkcoordintpair, RegionFileCompression regionfilecompression, int i) {
