...
public class EntityBee extends EntityAnimal implements IEntityAngerable, EntityBird {
    ...
    public boolean doHurtTarget(Entity entity) {
        ...
        boolean flag = entity.hurt(damagesource, (float) ((int) this.getAttributeValue(GenericAttributes.ATTACK_DAMAGE)));
    ...
    public class e extends EntityBee.a {
        ...
        private boolean pathfindDirectlyTowards(BlockPosition blockposition) {
            ...
            EntityBee.this.navigation.moveTo((double) blockposition.getX(), (double) blockposition.getY(), (double) blockposition.getZ(), 2, 1.0D);
