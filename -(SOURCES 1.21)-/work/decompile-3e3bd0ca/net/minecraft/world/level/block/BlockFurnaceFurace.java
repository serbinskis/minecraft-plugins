...
public class BlockFurnaceFurace extends BlockFurnace {
    ...
    public static final MapCodec<BlockFurnaceFurace> CODEC = simpleCodec(BlockFurnaceFurace::new);

    @Override
    public MapCodec<BlockFurnaceFurace> codec() {
        return BlockFurnaceFurace.CODEC;
    }
