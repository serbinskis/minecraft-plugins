package me.serbinskis.smptweaks.custom.magnetblock.block;
...
public class MagnetBlock extends CustomBlock {
    ...
    public void tick(Block block, long tick) {
        if (!me.serbinskis.smptweaks.custom.magnetblock.MagnetBlock.tweak.getGameRuleBoolean(block.getWorld())) { return; }
