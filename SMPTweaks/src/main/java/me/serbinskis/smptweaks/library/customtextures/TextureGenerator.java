...
public class TextureGenerator {
    public static int PACK_FORMAT = ReflectionUtils.getMajorPackFormat();
    public static String PACK_DESCRIPTION = "SMPTweaks resource pack for custom blocks.";
    public static String PACK_MCMETA = "{\"pack\":{ \"pack_format\": " + PACK_FORMAT + ", \"supported_formats\": [0, " + PACK_FORMAT + "], \"min_format\": 0, \"max_format\": " + PACK_FORMAT + ", \"description\": \"" + PACK_DESCRIPTION + "\" }}";
