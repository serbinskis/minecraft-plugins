...
public class Events implements Listener {
	...
	public void onEntityDamageByEntityEvent(EntityDamageByEntityEvent event) {
		...
		PvPDropInventory.timer.addPlayer((Player) event.getEntity(), PvPDropInventory.timeout);
		PvPDropInventory.timer.sendActionMessage((Player) event.getEntity());

		PvPDropInventory.timer.addPlayer((Player) event.getDamager(), PvPDropInventory.timeout);
		PvPDropInventory.timer.sendActionMessage((Player) event.getDamager());
	}
}